            ...
            if (score > alpha) {
                ...
                if (score >= beta) {
                    if (notTactical) {
                        ...
                        int quiethist_bonus = 10 + 200 * depth - 48 * predicted_cut_node;                        
                        int conthist_bonus  = 10 + 200 * depth - 48 * predicted_cut_node;
                        int pawnhist_bonus  = 10 + 200 * depth - 48 * predicted_cut_node;
