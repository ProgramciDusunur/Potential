...
/*╔═══════════════════════════════╗
  ...
  TUNE_INT MOVE_ORDER_HIST_MULT = 518;
  TUNE_INT SEE_PRUNING_HIST_MULT = 536;
  TUNE_INT SEE_QUIET_HIST_MULT = 133;
  TUNE_INT SEE_QUIET_HIST_DIVISOR = 12312;
  ...
  TUNE_INT NMP_BASE_REDUCTION = 5125;
  TUNE_INT NMP_DEPTH_MULTIPLIER = 242;
  TUNE_INT NMP_REDUCTION_DEPTH_MULT = 9851;
  TUNE_INT NMP_EVAL_MULT = 126;
  TUNE_INT NMP_FAILED_HIGH_HIST_BASE = 90;
  TUNE_INT NMP_FAILED_HIGH_HIST_MULT = 30895;
  TUNE_INT NMP_FAILED_HIGH_HIST_DIVISOR = 546;
  TUNE_INT NMP_EVAL_BETA_MARGIN = 54;
  TUNE_INT NMP_VERIFICATION_MARGIN = 25;
  TUNE_INT NMP_REDUCTION_DIVISOR = 8151423;
  TUNE_INT NMP_EVAL_DIVISOR = 45211;
  ...
  TUNE_DOUBLE LMR_TABLE_BASE_NOISY = 0.3843341509984605;
  TUNE_DOUBLE LMR_TABLE_NOISY_MULT = 128.0045145419546;
  TUNE_DOUBLE LMR_TABLE_BASE_QUIET = 0.9302832014615757;
  TUNE_DOUBLE LMR_TABLE_QUIET_MULT = 131.18641450605006;
  TUNE_INT LMR_FULL_DEPTH_MOVES = 2;
  TUNE_INT LMR_REDUCTION_LIMIT = 3;
  TUNE_INT DEEPER_LMR_MARGIN = 40;  
  TUNE_INT QUIET_HISTORY_LMR_MULT = 2094;
  TUNE_INT QUIET_HISTORY_LMR_DIVISOR = 7901149;
  TUNE_INT QUIET_HISTORY_LMR_MINIMUM_SCALAR = 3233;
  TUNE_INT QUIET_HISTORY_LMR_MAXIMUM_SCALAR = 3210;
  TUNE_INT PAWN_HISTORY_LMR_MULT = 778;
  TUNE_INT PAWN_HISTORY_LMR_DIVISOR = 9054652;
  TUNE_INT PAWN_HISTORY_LMR_MINIMUM_SCALAR = 2946;
  TUNE_INT PAWN_HISTORY_LMR_MAXIMUM_SCALAR = 3056;
  TUNE_INT NOISY_HISTORY_LMR_MULT = 95;  
  TUNE_INT NOISY_HISTORY_LMR_DIVISOR = 1316730;
  TUNE_INT QUIET_NON_PV_LMR_SCALAR = 1050;
  TUNE_INT CUT_NODE_LMR_SCALAR = 1971;
  TUNE_INT TT_PV_LMR_SCALAR = 1024;
  TUNE_INT TT_PV_FAIL_LOW_LMR_SCALAR = 1110;
  TUNE_INT TT_CAPTURE_LMR_SCALAR = 952;
  TUNE_INT GOOD_EVAL_LMR_SCALAR = 988;
  TUNE_INT GOOD_EVAL_LMR_MARGIN = 265;
  TUNE_INT FUTILITY_LMR_BASE = 179;
  TUNE_INT FUTILITY_LMR_MULT = 83;
  TUNE_INT FUTILITY_LMR_SCALAR = 974;
  TUNE_INT IMPROVING_LMR_SCALAR = 1090;
  TUNE_INT IMPROVING_FAIL_HIGH_MARGIN = 93;
  TUNE_INT GIVES_CHECK_LMR_SCALAR = 1008;
  TUNE_INT CUT_NODE_LMR_NO_TT_SCALAR = 955;
  TUNE_INT TT_PV_LMR_PV_NODE_SCALAR = 508;
  TUNE_INT TT_PV_LMR_IMPROVING_SCALAR = 259;  
  TUNE_INT LMR_DEPTH_HIST_MULT = 1961;
  TUNE_INT LMR_DEPTH_HIST_DIVISOR = 16814182;

  /*╔═══════════════════════╗
    ║     Move Ordering     ║
    ╚═══════════════════════╝*/
  TUNE_INT MAIN_HIST_WEIGHT = 1002;
  TUNE_INT CONTHIST_1_WEIGHT = 1029;
  TUNE_INT CONTHIST_2_WEIGHT = 1017;
  TUNE_INT CONTHIST_4_WEIGHT = 1052;
  TUNE_INT PAWN_HIST_WEIGHT = 1032;
  TUNE_INT MAIN_HIST_DIVISOR = 1065;
  TUNE_INT CONTHIST_1_DIVISOR = 1239;
  TUNE_INT CONTHIST_2_DIVISOR = 1172;
  TUNE_INT CONTHIST_4_DIVISOR = 977;
  TUNE_INT PAWN_HIST_DIVISOR = 1135;
  
  
  /*╔═══════════════════════╗
    ║ Late Move Pruning     ║
    ╚═══════════════════════╝*/
  TUNE_INT LMP_BASE = 3986;
  TUNE_INT LMP_MULTIPLIER = 3125;
  TUNE_INT LMP_HIST_LIMIT_NEG = 5876;
  TUNE_INT LMP_HIST_LIMIT_POS = 6222;
  TUNE_INT LMP_HIST_MULT = 260;
  TUNE_INT LMP_HIST_DIVISOR = 15631;

/*╔═════════════╗
  ║   Probcut   ║
  ╚═════════════╝*/
  TUNE_INT PROBCUT_BETA_MARGIN = 148;
  TUNE_INT PROBCUT_DEPTH = 5;
  TUNE_INT PROBCUT_DEPTH_SUBTRACTOR = 4;
  TUNE_INT PROBCUT_IMPROVING_MARGIN = 35;
  TUNE_INT PROBCUT_SEE_NOISY_THRESHOLD = 110;
  TUNE_INT PROBCUT_NOISY_HIST_MULT = 111;
  TUNE_INT PROBCUT_NOISY_HIST_DIVISOR = 1350689;
  TUNE_INT PROBCUT_REDUCTION_MULTIPLIER = 261;
  TUNE_INT PROBCUT_CUTNODE_SCALAR = 955;
  TUNE_INT PROBCUT_FP_BASE = 152;
  TUNE_INT PROBCUT_FP_MULT = 107;


/*╔═══════════════════╗
  ║   Small Probcut   ║
  ╚═══════════════════╝*/
  TUNE_INT SPROBCUT_BETA_MARGIN = 378;
  ...
  /*╔════════════════════╗
    ║ Futility Pruning   ║
    ╚════════════════════╝*/
  TUNE_INT FUTILITY_PRUNING_OFFSET[] = {0, 82, 45, 21, 11, 5};
  TUNE_INT FP_DEPTH = 5;
  TUNE_INT FP_MARGIN = 71;
  TUNE_INT BNFP_MARGIN = 77;
  TUNE_INT QUIET_HISTORY_PRUNING_MARGIN = 1917;
  TUNE_INT FP_HIST_MULT = 471;
  TUNE_INT FP_HIST_DIVISOR = 16862;
  
  
  /*╔══════════════════════════════╗
    ║ Reverse Futility Pruning     ║
    ╚══════════════════════════════╝*/
  TUNE_INT RFP_MARGIN = 61;
  TUNE_INT RFP_IMPROVING_MARGIN = 41;
  TUNE_INT RFP_CORRPLEXITY_MULT = 10631;
  TUNE_INT RFP_CORRPLEXITY_DIVISOR = 382;
  ...
  TUNE_INT RAZORING_FULL_MARGIN = 201;    
  TUNE_INT RAZORING_DEPTH_SCALE = 17;
  TUNE_INT RAZORING_VERIFY_MARGIN = 128;
  ...
  /*╔═════════════════════╗
    ...
    ╚═════════════════════╝*/
  TUNE_INT SE_DEPTH = 5;
  TUNE_INT LDSE_BASE_MARGIN = 25;
  TUNE_INT LDSE_CORRECTION_MULT = 692;
  TUNE_INT LDSE_CORRECTION_DIVISOR = 98653;
  TUNE_INT SE_TT_DEPTH_SUBTRACTOR = 3;
  // Positive Extensions
  TUNE_INT DOUBLE_EXTENSION_MARGIN = 18;
  TUNE_INT TRIPLE_EXTENSION_MARGIN = 35;
  TUNE_INT QUADRUPLE_EXTENSION_MARGIN = 91;
  TUNE_INT MULTI_LOW_DEPTH_EXT_MARGIN = 8;
  TUNE_INT QUADRUPLE_EXT_NOISY_BONUS = 161;
  TUNE_INT SE_CORRECTION_MULT = 908;
  TUNE_INT SE_CORRECTION_DIVISOR = 2911887;
  // Negative Extensions
  TUNE_INT TRIPLE_EXT_HIST_MULT = 32;
  TUNE_INT TRIPLE_EXT_HIST_DIVISOR = 16108;
  TUNE_INT TRIPLE_EXT_NOISY_BONUS = 82;
  ...
  /*╔══════════════════════════════╗
    ║      Aspiration Windows      ║
    ╚══════════════════════════════╝*/
  TUNE_INT ASP_WINDOW_BASE = 2342;
  TUNE_INT ASP_WINDOW_DIVISOR = 516;
  TUNE_INT ASP_WINDOW_MIN_DEPTH = 4;
  TUNE_DOUBLE ASP_WINDOW_MULTIPLIER = 1.8931556335538955;
...
/*╔═══════════════════════╗
  ...
  TUNE_INT QUIET_HIST_BONUS_DEPTH = 170;
  TUNE_INT QUIET_HIST_BONUS_MAX = 3980;
  TUNE_INT QUIET_HIST_MALUS_BASE = 8;
  TUNE_INT QUIET_HIST_MALUS_DEPTH = 192;
  TUNE_INT QUIET_HIST_FAILED_LOW_BONUS = 197;
  TUNE_INT QUIET_HIST_FAILED_LOW_MALUS = 209;
  TUNE_INT QUIET_HIST_MALUS_MAX = 3971;
  TUNE_INT HISTORY_RED_MULT = 1009;
  TUNE_INT HISTORY_RED_DIVISOR = 16793369;
  TUNE_INT CONTHIST_MULT = 1092;

  // Continuation History
  TUNE_INT CONTHIST_BONUS_BASE = 10;
  TUNE_INT CONTHIST_BONUS_DEPTH = 168;
  TUNE_INT CONTHIST_BONUS_MAX = 3935;
  TUNE_INT CONTHIST_MALUS_BASE = 11;
  TUNE_INT CONTHIST_MALUS_DEPTH = 201;
  TUNE_INT CONTHIST_FAILED_LOW_BONUS = 209;
  TUNE_INT CONTHIST_FAILED_LOW_MALUS = 178;
  TUNE_INT CONTHIST_MALUS_MAX = 4186;

  // Pawn History
  TUNE_INT PAWNHIST_BONUS_BASE = 8;
  TUNE_INT PAWNHIST_BONUS_DEPTH = 218;
  TUNE_INT PAWNHIST_BONUS_MAX = 3916;
  TUNE_INT PAWNHIST_MALUS_BASE = 7;
  TUNE_INT PAWNHIST_MALUS_DEPTH = 224;
  TUNE_INT PAWNHIST_FAILED_LOW_BONUS = 199;
  TUNE_INT PAWNHIST_FAILED_LOW_MALUS = 204;
  TUNE_INT PAWNHIST_MALUS_MAX = 3809;

  // Capture History
  TUNE_INT CAPTHIST_BONUS_BASE = 10;
  TUNE_INT CAPTHIST_BONUS_DEPTH = 188;
  TUNE_INT CAPTHIST_BONUS_MAX = 3834;
  TUNE_INT CAPTHIST_MALUS_BASE = 11;
  TUNE_INT CAPTHIST_MALUS_DEPTH = 238;
  TUNE_INT CAPTHIST_MALUS_MAX = 4171;  

  // Bad Quiet Index Scaling
  TUNE_INT BAD_QUIET_INDEX_SCALE = 30;
