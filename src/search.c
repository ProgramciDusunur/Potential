...
/*╔═══════════════════════════════╗
  ...
  TUNE_INT SEE_PRUNING_HIST_MULT = 533;
  TUNE_INT SEE_QUIET_HIST_MULT = 116;
  TUNE_INT SEE_QUIET_HIST_DIVISOR = 12084;
  ...
  TUNE_INT NMP_BASE_REDUCTION = 5110;
  TUNE_INT NMP_DEPTH_MULTIPLIER = 270;
  TUNE_INT NMP_REDUCTION_DEPTH_MULT = 8716;
  TUNE_INT NMP_EVAL_MULT = 131;
  TUNE_INT NMP_FAILED_HIGH_HIST_BASE = 94;
  TUNE_INT NMP_FAILED_HIGH_HIST_MULT = 29192;
  TUNE_INT NMP_FAILED_HIGH_HIST_DIVISOR = 652;
  TUNE_INT NMP_EVAL_BETA_MARGIN = 80;
  TUNE_INT NMP_VERIFICATION_MARGIN = 28;
  TUNE_INT NMP_REDUCTION_DIVISOR = 8545875;
  TUNE_INT NMP_EVAL_DIVISOR = 49546;
  ...
  TUNE_DOUBLE LMR_TABLE_BASE_NOISY = 0.3845684341988051;
  TUNE_DOUBLE LMR_TABLE_NOISY_MULT = 128.64932005312707;
  TUNE_DOUBLE LMR_TABLE_BASE_QUIET = 0.9568466862088642;
  TUNE_DOUBLE LMR_TABLE_QUIET_MULT = 123.68998811100667;
  TUNE_INT LMR_FULL_DEPTH_MOVES = 2;
  TUNE_INT LMR_REDUCTION_LIMIT = 3;
  TUNE_INT DEEPER_LMR_MARGIN = 38;  
  TUNE_INT QUIET_HISTORY_LMR_MULT = 1896;
  TUNE_INT QUIET_HISTORY_LMR_DIVISOR = 8020865;
  TUNE_INT QUIET_HISTORY_LMR_MINIMUM_SCALAR = 3248;
  TUNE_INT QUIET_HISTORY_LMR_MAXIMUM_SCALAR = 3129;
  TUNE_INT PAWN_HISTORY_LMR_MULT = 950;
  TUNE_INT PAWN_HISTORY_LMR_DIVISOR = 8895722;
  TUNE_INT PAWN_HISTORY_LMR_MINIMUM_SCALAR = 2953;
  TUNE_INT PAWN_HISTORY_LMR_MAXIMUM_SCALAR = 3166;
  TUNE_INT NOISY_HISTORY_LMR_MULT = 105;  
  TUNE_INT NOISY_HISTORY_LMR_DIVISOR = 1311638;
  TUNE_INT QUIET_NON_PV_LMR_SCALAR = 995;
  TUNE_INT CUT_NODE_LMR_SCALAR = 1904;
  TUNE_INT TT_PV_LMR_SCALAR = 1082;
  TUNE_INT TT_PV_FAIL_LOW_LMR_SCALAR = 1114;
  TUNE_INT TT_CAPTURE_LMR_SCALAR = 962;
  TUNE_INT GOOD_EVAL_LMR_SCALAR = 1026;
  TUNE_INT GOOD_EVAL_LMR_MARGIN = 320;
  TUNE_INT FUTILITY_LMR_BASE = 179;
  TUNE_INT FUTILITY_LMR_MULT = 79;
  TUNE_INT FUTILITY_LMR_SCALAR = 1017;
  TUNE_INT IMPROVING_LMR_SCALAR = 1070;
  TUNE_INT IMPROVING_FAIL_HIGH_MARGIN = 83;
  TUNE_INT GIVES_CHECK_LMR_SCALAR = 1025;
  TUNE_INT CUT_NODE_LMR_NO_TT_SCALAR = 1024;
  TUNE_INT TT_PV_LMR_PV_NODE_SCALAR = 504;
  TUNE_INT TT_PV_LMR_IMPROVING_SCALAR = 251;  
  TUNE_INT LMR_DEPTH_HIST_MULT = 2004;
  TUNE_INT LMR_DEPTH_HIST_DIVISOR = 16789091;

  /*╔═══════════════════════╗
    ║     Move Ordering     ║
    ╚═══════════════════════╝*/
  TUNE_INT MAIN_HIST_WEIGHT = 986;
  TUNE_INT CONTHIST_1_WEIGHT = 1046;
  TUNE_INT CONTHIST_2_WEIGHT = 1076;
  TUNE_INT CONTHIST_4_WEIGHT = 1098;
  TUNE_INT PAWN_HIST_WEIGHT = 1029;
  TUNE_INT MAIN_HIST_DIVISOR = 967;
  TUNE_INT CONTHIST_1_DIVISOR = 986;
  TUNE_INT CONTHIST_2_DIVISOR = 1126;
  TUNE_INT CONTHIST_4_DIVISOR = 1015;
  TUNE_INT PAWN_HIST_DIVISOR = 1145;
  
  
  /*╔═══════════════════════╗
    ║ Late Move Pruning     ║
    ╚═══════════════════════╝*/
  TUNE_INT LMP_BASE = 4242;
  TUNE_INT LMP_MULTIPLIER = 2957;
  TUNE_INT LMP_HIST_LIMIT_NEG = 6209;
  TUNE_INT LMP_HIST_LIMIT_POS = 6314;
  TUNE_INT LMP_HIST_MULT = 265;
  TUNE_INT LMP_HIST_DIVISOR = 17182;

/*╔═════════════╗
  ║   Probcut   ║
  ╚═════════════╝*/
  TUNE_INT PROBCUT_BETA_MARGIN = 154;
  ...
  TUNE_INT PROBCUT_NOISY_HIST_MULT = 100;
  TUNE_INT PROBCUT_NOISY_HIST_DIVISOR = 1241156;
  TUNE_INT PROBCUT_REDUCTION_MULTIPLIER = 247;
  TUNE_INT PROBCUT_CUTNODE_SCALAR = 974;
  TUNE_INT PROBCUT_FP_BASE = 166;
  TUNE_INT PROBCUT_FP_MULT = 98;


/*╔═══════════════════╗
  ║   Small Probcut   ║
  ╚═══════════════════╝*/
  TUNE_INT SPROBCUT_BETA_MARGIN = 380;
  ...
  /*╔════════════════════╗
    ║ Futility Pruning   ║
    ╚════════════════════╝*/
  TUNE_INT FUTILITY_PRUNING_OFFSET[] = {0, 87, 47, 21, 11, 5};
  TUNE_INT FP_DEPTH = 5;
  TUNE_INT FP_MARGIN = 72;
  TUNE_INT BNFP_MARGIN = 77;
  TUNE_INT QUIET_HISTORY_PRUNING_MARGIN = 1663;
  TUNE_INT FP_HIST_MULT = 493;
  TUNE_INT FP_HIST_DIVISOR = 14902;
  
  
  /*╔══════════════════════════════╗
    ║ Reverse Futility Pruning     ║
    ╚══════════════════════════════╝*/
  TUNE_INT RFP_MARGIN = 58;
  TUNE_INT RFP_IMPROVING_MARGIN = 42;
  TUNE_INT RFP_CORRPLEXITY_MULT = 9025;
  TUNE_INT RFP_CORRPLEXITY_DIVISOR = 559;
  ...
  TUNE_INT RAZORING_FULL_MARGIN = 212;    
  TUNE_INT RAZORING_DEPTH_SCALE = 16;
  TUNE_INT RAZORING_VERIFY_MARGIN = 120;
  ...
  /*╔═════════════════════╗
    ...
    ╚═════════════════════╝*/
  TUNE_INT SE_DEPTH = 5;
  TUNE_INT LDSE_BASE_MARGIN = 23;
  TUNE_INT LDSE_CORRECTION_MULT = 721;
  TUNE_INT LDSE_CORRECTION_DIVISOR = 98015;
  TUNE_INT SE_TT_DEPTH_SUBTRACTOR = 3;
  // Positive Extensions
  TUNE_INT DOUBLE_EXTENSION_MARGIN = -3;
  TUNE_INT TRIPLE_EXTENSION_MARGIN = 37;
  TUNE_INT QUADRUPLE_EXTENSION_MARGIN = 89;
  TUNE_INT MULTI_LOW_DEPTH_EXT_MARGIN = 5;
  TUNE_INT QUADRUPLE_EXT_NOISY_BONUS = 154;
  TUNE_INT SE_CORRECTION_MULT = 975;
  TUNE_INT SE_CORRECTION_DIVISOR = 2894700;
  // Negative Extensions
  TUNE_INT TRIPLE_EXT_HIST_MULT = 32;
  TUNE_INT TRIPLE_EXT_HIST_DIVISOR = 15592;
  TUNE_INT TRIPLE_EXT_NOISY_BONUS = 83;
  ...
  /*╔══════════════════════════════╗
    ║      Aspiration Windows      ║
    ╚══════════════════════════════╝*/
  TUNE_INT ASP_WINDOW_BASE = 2156;
  TUNE_INT ASP_WINDOW_DIVISOR = 512;
  TUNE_INT ASP_WINDOW_MIN_DEPTH = 4;
  TUNE_DOUBLE ASP_WINDOW_MULTIPLIER = 1.8933644140367487;
...
/*╔═══════════════════════╗
  ...
  TUNE_INT QUIET_HIST_BONUS_DEPTH = 167;
  TUNE_INT QUIET_HIST_BONUS_MAX = 4031;
  TUNE_INT QUIET_HIST_MALUS_BASE = 9;
  TUNE_INT QUIET_HIST_MALUS_DEPTH = 196;
  TUNE_INT QUIET_HIST_FAILED_LOW_BONUS = 217;
  TUNE_INT QUIET_HIST_FAILED_LOW_MALUS = 196;
  TUNE_INT QUIET_HIST_MALUS_MAX = 3961;
  TUNE_INT HISTORY_RED_MULT = 1072;
  TUNE_INT HISTORY_RED_DIVISOR = 16782155;
  TUNE_INT CONTHIST_MULT = 1099;

  // Continuation History
  TUNE_INT CONTHIST_BONUS_BASE = 9;
  TUNE_INT CONTHIST_BONUS_DEPTH = 167;
  TUNE_INT CONTHIST_BONUS_MAX = 3766;
  TUNE_INT CONTHIST_MALUS_BASE = 12;
  TUNE_INT CONTHIST_MALUS_DEPTH = 209;
  TUNE_INT CONTHIST_FAILED_LOW_BONUS = 209;
  TUNE_INT CONTHIST_FAILED_LOW_MALUS = 170;
  TUNE_INT CONTHIST_MALUS_MAX = 4256;

  // Pawn History
  TUNE_INT PAWNHIST_BONUS_BASE = 8;
  TUNE_INT PAWNHIST_BONUS_DEPTH = 217;
  TUNE_INT PAWNHIST_BONUS_MAX = 4184;
  TUNE_INT PAWNHIST_MALUS_BASE = 8;
  TUNE_INT PAWNHIST_MALUS_DEPTH = 235;
  TUNE_INT PAWNHIST_FAILED_LOW_BONUS = 173;
  TUNE_INT PAWNHIST_FAILED_LOW_MALUS = 206;
  TUNE_INT PAWNHIST_MALUS_MAX = 3574;

  // Capture History
  TUNE_INT CAPTHIST_BONUS_BASE = 8;
  TUNE_INT CAPTHIST_BONUS_DEPTH = 188;
  TUNE_INT CAPTHIST_BONUS_MAX = 4002;
  TUNE_INT CAPTHIST_MALUS_BASE = 11;
  TUNE_INT CAPTHIST_MALUS_DEPTH = 236;
  TUNE_INT CAPTHIST_MALUS_MAX = 4206;  
