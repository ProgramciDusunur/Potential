...
/*╔═══════════════════════════════╗
  ...
  TUNE_INT SEE_QUIET_THRESHOLD = -64;
  TUNE_INT SEE_NOISY_THRESHOLD = -31;
  TUNE_INT SEE_DEPTH = 10;
  TUNE_INT MOVE_ORDER_HIST_MULT = 448;
  TUNE_INT SEE_PRUNING_HIST_MULT = 540;
  TUNE_INT SEE_QUIET_HIST_MULT = 175;
  ...
  TUNE_INT NMP_BASE_REDUCTION = 5135;
  TUNE_INT NMP_DEPTH_MULTIPLIER = 281;
  TUNE_INT NMP_REDUCTION_DEPTH_MULT = 11236;
  TUNE_INT NMP_EVAL_MULT = 120;
  TUNE_INT NMP_FAILED_HIGH_HIST_BASE = 86;
  TUNE_INT NMP_FAILED_HIGH_HIST_MULT = 28302;
  TUNE_INT NMP_FAILED_HIGH_HIST_DIVISOR = 500;
  TUNE_INT NMP_EVAL_BETA_MARGIN = 20;
  TUNE_INT NMP_VERIFICATION_MARGIN = 27;
  TUNE_INT NMP_REDUCTION_DIVISOR = 8760600;
  TUNE_INT NMP_EVAL_DIVISOR = 52158;
  ...
  TUNE_DOUBLE LMR_TABLE_BASE_NOISY = 0.40086822822453383;
  TUNE_DOUBLE LMR_TABLE_NOISY_MULT = 128.65918157463608;
  TUNE_DOUBLE LMR_TABLE_BASE_QUIET = 0.9665770353326566;
  TUNE_DOUBLE LMR_TABLE_QUIET_MULT = 152.91177073055812;
  TUNE_INT LMR_FULL_DEPTH_MOVES = 2;
  TUNE_INT LMR_REDUCTION_LIMIT = 3;
  TUNE_INT DEEPER_LMR_MARGIN = 39;  
  TUNE_INT QUIET_HISTORY_LMR_MULT = 2406;
  TUNE_INT QUIET_HISTORY_LMR_DIVISOR = 8393396;
  TUNE_INT QUIET_HISTORY_LMR_MINIMUM_SCALAR = 3182;
  TUNE_INT QUIET_HISTORY_LMR_MAXIMUM_SCALAR = 3154;
  TUNE_INT PAWN_HISTORY_LMR_MULT = 1142;
  TUNE_INT PAWN_HISTORY_LMR_DIVISOR = 9992347;
  TUNE_INT PAWN_HISTORY_LMR_MINIMUM_SCALAR = 2907;
  TUNE_INT PAWN_HISTORY_LMR_MAXIMUM_SCALAR = 2890;
  TUNE_INT NOISY_HISTORY_LMR_MULT = 119;  
  TUNE_INT NOISY_HISTORY_LMR_DIVISOR = 1295420;
  TUNE_INT QUIET_NON_PV_LMR_SCALAR = 1091;
  TUNE_INT CUT_NODE_LMR_SCALAR = 1949;
  TUNE_INT TT_PV_LMR_SCALAR = 962;
  TUNE_INT TT_PV_FAIL_LOW_LMR_SCALAR = 1096;
  TUNE_INT TT_CAPTURE_LMR_SCALAR = 1058;
  TUNE_INT GOOD_EVAL_LMR_SCALAR = 1082;
  TUNE_INT GOOD_EVAL_LMR_MARGIN = 277;
  TUNE_INT FUTILITY_LMR_BASE = 184;
  TUNE_INT FUTILITY_LMR_MULT = 90;
  TUNE_INT FUTILITY_LMR_SCALAR = 997;
  TUNE_INT IMPROVING_LMR_SCALAR = 1059;
  TUNE_INT IMPROVING_FAIL_HIGH_MARGIN = 88;
  TUNE_INT GIVES_CHECK_LMR_SCALAR = 1042;
  TUNE_INT LMR_FUTILITY_OFFSET[] = {0, 164, 82, 41, 20, 10};
  TUNE_INT LMR_DEPTH_HIST_MULT = 2037;
  ...
  TUNE_INT LMP_HIST_MULT = 231;
  TUNE_INT LMP_HIST_DIVISOR = 17120;

/*╔═════════════╗
  ║   Probcut   ║
  ╚═════════════╝*/
  TUNE_INT PROBCUT_BETA_MARGIN = 121;
  TUNE_INT PROBCUT_DEPTH = 5;
  TUNE_INT PROBCUT_DEPTH_SUBTRACTOR = 4;
  TUNE_INT PROBCUT_IMPROVING_MARGIN = 39;
  TUNE_INT PROBCUT_SEE_NOISY_THRESHOLD = 91;
  TUNE_INT PROBCUT_NOISY_HIST_MULT = 96;
  TUNE_INT PROBCUT_FP_BASE = 142;
  TUNE_INT PROBCUT_FP_MULT = 106;


/*╔═══════════════════╗
  ║   Small Probcut   ║
  ╚═══════════════════╝*/
  TUNE_INT SPROBCUT_BETA_MARGIN = 439;
  ...
  /*╔════════════════════╗
    ║ Futility Pruning   ║
    ╚════════════════════╝*/
  TUNE_INT FUTILITY_PRUNING_OFFSET[] = {0, 83, 47, 21, 10, 6};
  TUNE_INT FP_DEPTH = 5;
  TUNE_INT FP_MARGIN = 59;
  TUNE_INT BNFP_MARGIN = 78;
  TUNE_INT QUIET_HISTORY_PRUNING_MARGIN = 1588;
  TUNE_INT FP_HIST_MULT = 407;
  TUNE_INT FP_HIST_DIVISOR = 16149;
  
  
  /*╔══════════════════════════════╗
    ║ Reverse Futility Pruning     ║
    ╚══════════════════════════════╝*/
  TUNE_INT RFP_MARGIN = 51;
  TUNE_INT RFP_IMPROVING_MARGIN = 34;
  TUNE_INT RFP_CORRPLEXITY_MULT = 11035;
  TUNE_INT RFP_CORRPLEXITY_DIVISOR = 370;
  ...
  TUNE_INT RAZORING_FULL_MARGIN = 227;    
  TUNE_INT RAZORING_DEPTH_SCALE = 16;
  TUNE_INT RAZORING_VERIFY_MARGIN = 146;
  ...
  /*╔═════════════════════╗
    ...
    ╚═════════════════════╝*/
  TUNE_INT SE_DEPTH = 5;
  TUNE_INT LDSE_BASE_MARGIN = 37;
  TUNE_INT LDSE_CORRECTION_MULT = 718;
  TUNE_INT LDSE_CORRECTION_DIVISOR = 100497;
  ...
  /*╔══════════════════════════════╗
    ║      Aspiration Windows      ║
    ╚══════════════════════════════╝*/
  TUNE_INT ASP_WINDOW_BASE = 2877;
  TUNE_INT ASP_WINDOW_DIVISOR = 363;
  TUNE_INT ASP_WINDOW_MIN_DEPTH = 4;
  TUNE_DOUBLE ASP_WINDOW_MULTIPLIER = 2.008387470488561;
...
/*╔═══════════════════════╗
  ...
  // Quiet History
  TUNE_INT QUIET_HIST_BONUS_BASE = 6;
  TUNE_INT QUIET_HIST_BONUS_DEPTH = 187;
  TUNE_INT QUIET_HIST_BONUS_MAX = 4347;
  TUNE_INT QUIET_HIST_MALUS_BASE = 8;
  TUNE_INT QUIET_HIST_MALUS_DEPTH = 180;
  TUNE_INT QUIET_HIST_FAILED_LOW_BONUS = 226;
  TUNE_INT QUIET_HIST_FAILED_LOW_MALUS = 190;
  TUNE_INT QUIET_HIST_MALUS_MAX = 3940;
  TUNE_INT HISTORY_RED_MULT = 921;
  TUNE_INT HISTORY_RED_DIVISOR = 16716808;
  TUNE_INT CONTHIST_MULT = 1041;

  // Continuation History
  TUNE_INT CONTHIST_BONUS_BASE = 8;
  TUNE_INT CONTHIST_BONUS_DEPTH = 144;
  TUNE_INT CONTHIST_BONUS_MAX = 3795;
  TUNE_INT CONTHIST_MALUS_BASE = 14;
  TUNE_INT CONTHIST_MALUS_DEPTH = 214;
  TUNE_INT CONTHIST_FAILED_LOW_BONUS = 222;
  TUNE_INT CONTHIST_FAILED_LOW_MALUS = 186;
  TUNE_INT CONTHIST_MALUS_MAX = 4220;

  // Pawn History
  TUNE_INT PAWNHIST_BONUS_BASE = 10;
  TUNE_INT PAWNHIST_BONUS_DEPTH = 210;
  TUNE_INT PAWNHIST_BONUS_MAX = 4242;
  TUNE_INT PAWNHIST_MALUS_BASE = 10;
  TUNE_INT PAWNHIST_MALUS_DEPTH = 225;
  TUNE_INT PAWNHIST_FAILED_LOW_BONUS = 158;
  TUNE_INT PAWNHIST_FAILED_LOW_MALUS = 190;
  TUNE_INT PAWNHIST_MALUS_MAX = 4068;

  // Capture History
  TUNE_INT CAPTHIST_BONUS_BASE = 13;
  TUNE_INT CAPTHIST_BONUS_DEPTH = 187;
  TUNE_INT CAPTHIST_BONUS_MAX = 3856;
  TUNE_INT CAPTHIST_MALUS_BASE = 12;
  TUNE_INT CAPTHIST_MALUS_DEPTH = 273;
  TUNE_INT CAPTHIST_MALUS_MAX = 4640;  

  // Bad Quiet Index Scaling
  TUNE_INT BAD_QUIET_INDEX_SCALE = 23;
