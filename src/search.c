...
/*╔═══════════════════════════════╗
  ...
  TUNE_INT SEE_QUIET_THRESHOLD = -63;
  TUNE_INT SEE_NOISY_THRESHOLD = -30;
  TUNE_INT SEE_DEPTH = 10;
  TUNE_INT MOVE_ORDER_HIST_MULT = 458;
  TUNE_INT SEE_PRUNING_HIST_MULT = 534;
  TUNE_INT SEE_QUIET_HIST_MULT = 138;
  ...
  TUNE_INT NMP_BASE_REDUCTION = 5138;
  TUNE_INT NMP_DEPTH_MULTIPLIER = 271;
  TUNE_INT NMP_REDUCTION_DEPTH_MULT = 16;
  TUNE_INT NMP_EVAL_MULT = 127;
  TUNE_INT NMP_FAILED_HIGH_HIST_BASE = 94;
  TUNE_INT NMP_FAILED_HIGH_HIST_MULT = 55;
  TUNE_INT NMP_EVAL_BETA_MARGIN = 74;
  TUNE_INT NMP_VERIFICATION_MARGIN = 30;
  TUNE_INT NMP_REDUCTION_DIVISOR = 16708;
  TUNE_INT NMP_EVAL_DIVISOR = 47622;
  ...
  TUNE_DOUBLE LMR_TABLE_BASE_NOISY = 0.38935418647387116;
  TUNE_DOUBLE LMR_TABLE_NOISY_MULT = 132.04647206014943;
  TUNE_DOUBLE LMR_TABLE_BASE_QUIET = 1.011541348816744;
  TUNE_DOUBLE LMR_TABLE_QUIET_MULT = 128.5872516308196;
  TUNE_INT LMR_FULL_DEPTH_MOVES = 2;
  TUNE_INT LMR_REDUCTION_LIMIT = 3;
  TUNE_INT DEEPER_LMR_MARGIN = 36;  
  TUNE_INT QUIET_HISTORY_LMR_MULT = 4;
  TUNE_INT QUIET_HISTORY_LMR_DIVISOR = 16240;
  TUNE_INT QUIET_HISTORY_LMR_MINIMUM_SCALAR = 3145;
  TUNE_INT QUIET_HISTORY_LMR_MAXIMUM_SCALAR = 3186;
  TUNE_INT PAWN_HISTORY_LMR_MULT = 3;
  TUNE_INT PAWN_HISTORY_LMR_DIVISOR = 17651;
  TUNE_INT PAWN_HISTORY_LMR_MINIMUM_SCALAR = 2982;
  TUNE_INT PAWN_HISTORY_LMR_MAXIMUM_SCALAR = 3069;
  TUNE_INT NOISY_HISTORY_LMR_MULT = 110;  
  TUNE_INT NOISY_HISTORY_LMR_DIVISOR = 1305259;
  TUNE_INT QUIET_NON_PV_LMR_SCALAR = 963;
  TUNE_INT CUT_NODE_LMR_SCALAR = 1889;
  TUNE_INT TT_PV_LMR_SCALAR = 1074;
  TUNE_INT TT_PV_FAIL_LOW_LMR_SCALAR = 1076;
  TUNE_INT TT_CAPTURE_LMR_SCALAR = 1000;
  TUNE_INT GOOD_EVAL_LMR_SCALAR = 998;
  TUNE_INT GOOD_EVAL_LMR_MARGIN = 315;
  TUNE_INT FUTILITY_LMR_BASE = 167;
  TUNE_INT FUTILITY_LMR_MULT = 79;
  TUNE_INT FUTILITY_LMR_SCALAR = 981;
  TUNE_INT IMPROVING_LMR_SCALAR = 1035;
  TUNE_INT IMPROVING_FAIL_HIGH_MARGIN = 93;
  TUNE_INT GIVES_CHECK_LMR_SCALAR = 1050;
  TUNE_INT LMR_FUTILITY_OFFSET[] = {0, 164, 82, 41, 20, 10};
  TUNE_INT LMR_DEPTH_HIST_MULT = 2025;
  ...
  TUNE_INT LMP_HIST_DIVISOR = 16590;

/*╔═════════════╗
  ║   Probcut   ║
  ╚═════════════╝*/
  TUNE_INT PROBCUT_BETA_MARGIN = 143;
  ...
  TUNE_INT PROBCUT_NOISY_HIST_MULT = 110;
  TUNE_INT PROBCUT_FP_BASE = 156;
  TUNE_INT PROBCUT_FP_MULT = 102;


/*╔═══════════════════╗
  ║   Small Probcut   ║
  ╚═══════════════════╝*/
  TUNE_INT SPROBCUT_BETA_MARGIN = 391;
  ...
  /*╔════════════════════╗
    ║ Futility Pruning   ║
    ╚════════════════════╝*/
  TUNE_INT FUTILITY_PRUNING_OFFSET[] = {0, 82, 47, 21, 10, 5};
  TUNE_INT FP_DEPTH = 5;
  TUNE_INT FP_MARGIN = 74;
  TUNE_INT BNFP_MARGIN = 75;
  TUNE_INT QUIET_HISTORY_PRUNING_MARGIN = 1839;
  TUNE_INT FP_HIST_MULT = 432;
  TUNE_INT FP_HIST_DIVISOR = 16136;
  
  
  /*╔══════════════════════════════╗
    ║ Reverse Futility Pruning     ║
    ╚══════════════════════════════╝*/
  TUNE_INT RFP_MARGIN = 56;
  TUNE_INT RFP_IMPROVING_MARGIN = 41;
  TUNE_INT RFP_CORRPLEXITY_MULT = 18;
  ...
  TUNE_INT RAZORING_FULL_MARGIN = 217;    
  ...
  TUNE_INT LDSE_CORRECTION_MULT = 722;
  TUNE_INT LDSE_CORRECTION_DIVISOR = 98881;
  ...
  /*╔══════════════════════════════╗
    ║      Aspiration Windows      ║
    ╚══════════════════════════════╝*/
  TUNE_INT ASP_WINDOW_BASE = 6;
  TUNE_INT ASP_WINDOW_MIN_DEPTH = 4;
  TUNE_DOUBLE ASP_WINDOW_MULTIPLIER = 1.9603985234529453;
...
/*╔═══════════════════════╗
  ...
  TUNE_INT QUIET_HIST_BONUS_DEPTH = 179;
  TUNE_INT QUIET_HIST_BONUS_MAX = 4159;
  TUNE_INT QUIET_HIST_MALUS_BASE = 8;
  TUNE_INT QUIET_HIST_MALUS_DEPTH = 179;
  TUNE_INT QUIET_HIST_FAILED_LOW_BONUS = 217;
  TUNE_INT QUIET_HIST_FAILED_LOW_MALUS = 215;
  TUNE_INT QUIET_HIST_MALUS_MAX = 3979;
  TUNE_INT HISTORY_RED_MULT = 1044;
  TUNE_INT HISTORY_RED_DIVISOR = 16785767;
  TUNE_INT CONTHIST_MULT = 1071;

  // Continuation History
  TUNE_INT CONTHIST_BONUS_BASE = 9;
  TUNE_INT CONTHIST_BONUS_DEPTH = 155;
  TUNE_INT CONTHIST_BONUS_MAX = 3889;
  TUNE_INT CONTHIST_MALUS_BASE = 12;
  TUNE_INT CONTHIST_MALUS_DEPTH = 222;
  TUNE_INT CONTHIST_FAILED_LOW_BONUS = 218;
  TUNE_INT CONTHIST_FAILED_LOW_MALUS = 173;
  TUNE_INT CONTHIST_MALUS_MAX = 4128;

  // Pawn History
  TUNE_INT PAWNHIST_BONUS_BASE = 8;
  TUNE_INT PAWNHIST_BONUS_DEPTH = 206;
  TUNE_INT PAWNHIST_BONUS_MAX = 4155;
  TUNE_INT PAWNHIST_MALUS_BASE = 8;
  TUNE_INT PAWNHIST_MALUS_DEPTH = 210;
  TUNE_INT PAWNHIST_FAILED_LOW_BONUS = 179;
  TUNE_INT PAWNHIST_FAILED_LOW_MALUS = 198;
  TUNE_INT PAWNHIST_MALUS_MAX = 3861;

  // Capture History
  TUNE_INT CAPTHIST_BONUS_BASE = 11;
  TUNE_INT CAPTHIST_BONUS_DEPTH = 194;
  TUNE_INT CAPTHIST_BONUS_MAX = 3913;
  TUNE_INT CAPTHIST_MALUS_BASE = 13;
  TUNE_INT CAPTHIST_MALUS_DEPTH = 226;
  TUNE_INT CAPTHIST_MALUS_MAX = 4227;  
