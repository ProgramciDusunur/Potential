...
/*╔═══════════════════════════════╗
  ...
  TUNE_INT SEE_MOVE_ORDERING_THRESHOLD = -59;
  TUNE_INT SEE_QUIET_THRESHOLD = -65;
  TUNE_INT SEE_NOISY_THRESHOLD = -34;
  TUNE_INT SEE_DEPTH = 10;
  TUNE_INT MOVE_ORDER_HIST_MULT = 454;
  TUNE_INT SEE_PRUNING_HIST_MULT = 518;
  TUNE_INT SEE_QUIET_HIST_MULT = 118;
  ...
  TUNE_INT NMP_BASE_REDUCTION = 5193;
  TUNE_INT NMP_DEPTH_MULTIPLIER = 246;
  TUNE_INT NMP_REDUCTION_DEPTH_MULT = 7796;
  TUNE_INT NMP_EVAL_MULT = 121;
  TUNE_INT NMP_FAILED_HIGH_HIST_BASE = 106;
  TUNE_INT NMP_FAILED_HIGH_HIST_MULT = 30247;
  TUNE_INT NMP_FAILED_HIGH_HIST_DIVISOR = 549;
  TUNE_INT NMP_EVAL_BETA_MARGIN = 80;
  TUNE_INT NMP_VERIFICATION_MARGIN = 31;
  TUNE_INT NMP_REDUCTION_DIVISOR = 8277490;
  TUNE_INT NMP_EVAL_DIVISOR = 42810;
  ...
  TUNE_DOUBLE LMR_TABLE_BASE_NOISY = 0.38675542993466827;
  TUNE_DOUBLE LMR_TABLE_NOISY_MULT = 128.16568277403812;
  TUNE_DOUBLE LMR_TABLE_BASE_QUIET = 0.9582893936235429;
  TUNE_DOUBLE LMR_TABLE_QUIET_MULT = 130.21751569875622;
  TUNE_INT LMR_FULL_DEPTH_MOVES = 2;
  TUNE_INT LMR_REDUCTION_LIMIT = 3;
  TUNE_INT DEEPER_LMR_MARGIN = 37;  
  TUNE_INT QUIET_HISTORY_LMR_MULT = 1900;
  TUNE_INT QUIET_HISTORY_LMR_DIVISOR = 8325507;
  TUNE_INT QUIET_HISTORY_LMR_MINIMUM_SCALAR = 3169;
  TUNE_INT QUIET_HISTORY_LMR_MAXIMUM_SCALAR = 3252;
  TUNE_INT PAWN_HISTORY_LMR_MULT = 1210;
  TUNE_INT PAWN_HISTORY_LMR_DIVISOR = 8993766;
  TUNE_INT PAWN_HISTORY_LMR_MINIMUM_SCALAR = 3003;
  TUNE_INT PAWN_HISTORY_LMR_MAXIMUM_SCALAR = 3095;
  TUNE_INT NOISY_HISTORY_LMR_MULT = 109;  
  TUNE_INT NOISY_HISTORY_LMR_DIVISOR = 1313567;
  TUNE_INT QUIET_NON_PV_LMR_SCALAR = 974;
  TUNE_INT CUT_NODE_LMR_SCALAR = 1958;
  TUNE_INT TT_PV_LMR_SCALAR = 1048;
  TUNE_INT TT_PV_FAIL_LOW_LMR_SCALAR = 1151;
  TUNE_INT TT_CAPTURE_LMR_SCALAR = 977;
  TUNE_INT GOOD_EVAL_LMR_SCALAR = 1011;
  TUNE_INT GOOD_EVAL_LMR_MARGIN = 295;
  TUNE_INT FUTILITY_LMR_BASE = 172;
  TUNE_INT FUTILITY_LMR_MULT = 84;
  TUNE_INT FUTILITY_LMR_SCALAR = 944;
  TUNE_INT IMPROVING_LMR_SCALAR = 1077;
  TUNE_INT IMPROVING_FAIL_HIGH_MARGIN = 87;
  TUNE_INT GIVES_CHECK_LMR_SCALAR = 1067;
  TUNE_INT LMR_FUTILITY_OFFSET[] = {0, 164, 82, 41, 20, 10};
  TUNE_INT LMR_DEPTH_HIST_MULT = 2019;
  ...
  TUNE_INT LMP_HIST_MULT = 243;
  TUNE_INT LMP_HIST_DIVISOR = 17003;

/*╔═════════════╗
  ║   Probcut   ║
  ╚═════════════╝*/
  TUNE_INT PROBCUT_BETA_MARGIN = 171;
  TUNE_INT PROBCUT_DEPTH = 5;
  TUNE_INT PROBCUT_DEPTH_SUBTRACTOR = 4;
  TUNE_INT PROBCUT_IMPROVING_MARGIN = 42;
  TUNE_INT PROBCUT_SEE_NOISY_THRESHOLD = 110;
  TUNE_INT PROBCUT_NOISY_HIST_MULT = 98;
  TUNE_INT PROBCUT_FP_BASE = 158;
  TUNE_INT PROBCUT_FP_MULT = 97;


/*╔═══════════════════╗
  ║   Small Probcut   ║
  ╚═══════════════════╝*/
  TUNE_INT SPROBCUT_BETA_MARGIN = 404;
  ...
  /*╔════════════════════╗
    ║ Futility Pruning   ║
    ╚════════════════════╝*/
  TUNE_INT FUTILITY_PRUNING_OFFSET[] = {0, 91, 43, 21, 11, 6};
  TUNE_INT FP_DEPTH = 5;
  TUNE_INT FP_MARGIN = 77;
  TUNE_INT BNFP_MARGIN = 75;
  TUNE_INT QUIET_HISTORY_PRUNING_MARGIN = 1889;
  TUNE_INT FP_HIST_MULT = 474;
  TUNE_INT FP_HIST_DIVISOR = 15588;
  ...
  TUNE_INT RFP_CORRPLEXITY_MULT = 8565;
  TUNE_INT RFP_CORRPLEXITY_DIVISOR = 531;
  ...
  TUNE_INT RAZORING_FULL_MARGIN = 210;    
  TUNE_INT RAZORING_DEPTH_SCALE = 14;
  TUNE_INT RAZORING_VERIFY_MARGIN = 117;
  ...
  TUNE_INT LDSE_CORRECTION_MULT = 733;
  TUNE_INT LDSE_CORRECTION_DIVISOR = 98683;
  ...
  /*╔══════════════════════════════╗
    ║      Aspiration Windows      ║
    ╚══════════════════════════════╝*/
  TUNE_INT ASP_WINDOW_BASE = 2176;
  TUNE_INT ASP_WINDOW_DIVISOR = 505;
  TUNE_INT ASP_WINDOW_MIN_DEPTH = 4;
  TUNE_DOUBLE ASP_WINDOW_MULTIPLIER = 2.086350920679874;
...
/*╔═══════════════════════╗
  ...
  // Quiet History
  TUNE_INT QUIET_HIST_BONUS_BASE = 10;
  TUNE_INT QUIET_HIST_BONUS_DEPTH = 172;
  TUNE_INT QUIET_HIST_BONUS_MAX = 4047;
  TUNE_INT QUIET_HIST_MALUS_BASE = 10;
  TUNE_INT QUIET_HIST_MALUS_DEPTH = 199;
  TUNE_INT QUIET_HIST_FAILED_LOW_BONUS = 214;
  TUNE_INT QUIET_HIST_FAILED_LOW_MALUS = 206;
  TUNE_INT QUIET_HIST_MALUS_MAX = 4157;
  TUNE_INT HISTORY_RED_MULT = 1072;
  TUNE_INT HISTORY_RED_DIVISOR = 16892311;
  TUNE_INT CONTHIST_MULT = 1115;

  // Continuation History
  TUNE_INT CONTHIST_BONUS_BASE = 10;
  TUNE_INT CONTHIST_BONUS_DEPTH = 167;
  TUNE_INT CONTHIST_BONUS_MAX = 3705;
  TUNE_INT CONTHIST_MALUS_BASE = 10;
  TUNE_INT CONTHIST_MALUS_DEPTH = 210;
  TUNE_INT CONTHIST_FAILED_LOW_BONUS = 207;
  TUNE_INT CONTHIST_FAILED_LOW_MALUS = 177;
  TUNE_INT CONTHIST_MALUS_MAX = 4188;

  // Pawn History
  TUNE_INT PAWNHIST_BONUS_BASE = 9;
  TUNE_INT PAWNHIST_BONUS_DEPTH = 234;
  TUNE_INT PAWNHIST_BONUS_MAX = 3950;
  TUNE_INT PAWNHIST_MALUS_BASE = 8;
  TUNE_INT PAWNHIST_MALUS_DEPTH = 214;
  TUNE_INT PAWNHIST_FAILED_LOW_BONUS = 176;
  TUNE_INT PAWNHIST_FAILED_LOW_MALUS = 218;
  TUNE_INT PAWNHIST_MALUS_MAX = 3564;

  // Capture History
  TUNE_INT CAPTHIST_BONUS_BASE = 9;
  TUNE_INT CAPTHIST_BONUS_DEPTH = 205;
  TUNE_INT CAPTHIST_BONUS_MAX = 4157;
  TUNE_INT CAPTHIST_MALUS_BASE = 13;
  TUNE_INT CAPTHIST_MALUS_DEPTH = 238;
  TUNE_INT CAPTHIST_MALUS_MAX = 4187;  

  // Bad Quiet Index Scaling
  TUNE_INT BAD_QUIET_INDEX_SCALE = 28;
