...
/*╔═══════════════════════════════╗
  ...
  TUNE_INT SEE_MOVE_ORDERING_THRESHOLD = -60;
  TUNE_INT SEE_QUIET_THRESHOLD = -66;
  TUNE_INT SEE_NOISY_THRESHOLD = -32;
  TUNE_INT SEE_DEPTH = 10;
  TUNE_INT MOVE_ORDER_HIST_MULT = 454;
  TUNE_INT SEE_PRUNING_HIST_MULT = 544;
  TUNE_INT SEE_QUIET_HIST_MULT = 121;
  TUNE_INT SEE_QUIET_HIST_DIVISOR = 12197;
  ...
  TUNE_INT NMP_BASE_REDUCTION = 5130;
  TUNE_INT NMP_DEPTH_MULTIPLIER = 268;
  TUNE_INT NMP_REDUCTION_DEPTH_MULT = 8529;
  TUNE_INT NMP_EVAL_MULT = 129;
  TUNE_INT NMP_FAILED_HIGH_HIST_BASE = 97;
  TUNE_INT NMP_FAILED_HIGH_HIST_MULT = 29217;
  TUNE_INT NMP_FAILED_HIGH_HIST_DIVISOR = 570;
  TUNE_INT NMP_EVAL_BETA_MARGIN = 78;
  TUNE_INT NMP_VERIFICATION_MARGIN = 29;
  TUNE_INT NMP_REDUCTION_DIVISOR = 8436348;
  TUNE_INT NMP_EVAL_DIVISOR = 47661;
  ...
  TUNE_DOUBLE LMR_TABLE_BASE_NOISY = 0.3885371533764134;
  TUNE_DOUBLE LMR_TABLE_NOISY_MULT = 130.45075091111556;
  TUNE_DOUBLE LMR_TABLE_BASE_QUIET = 0.9782658749675517;
  TUNE_DOUBLE LMR_TABLE_QUIET_MULT = 124.18311585855776;
  TUNE_INT LMR_FULL_DEPTH_MOVES = 2;
  TUNE_INT LMR_REDUCTION_LIMIT = 3;
  TUNE_INT DEEPER_LMR_MARGIN = 38;  
  TUNE_INT QUIET_HISTORY_LMR_MULT = 1766;
  TUNE_INT QUIET_HISTORY_LMR_DIVISOR = 8072885;
  TUNE_INT QUIET_HISTORY_LMR_MINIMUM_SCALAR = 3209;
  TUNE_INT QUIET_HISTORY_LMR_MAXIMUM_SCALAR = 3165;
  TUNE_INT PAWN_HISTORY_LMR_MULT = 981;
  TUNE_INT PAWN_HISTORY_LMR_DIVISOR = 8869319;
  TUNE_INT PAWN_HISTORY_LMR_MINIMUM_SCALAR = 2983;
  TUNE_INT PAWN_HISTORY_LMR_MAXIMUM_SCALAR = 3117;
  TUNE_INT NOISY_HISTORY_LMR_MULT = 109;  
  TUNE_INT NOISY_HISTORY_LMR_DIVISOR = 1314698;
  TUNE_INT QUIET_NON_PV_LMR_SCALAR = 995;
  TUNE_INT CUT_NODE_LMR_SCALAR = 1894;
  TUNE_INT TT_PV_LMR_SCALAR = 1074;
  TUNE_INT TT_PV_FAIL_LOW_LMR_SCALAR = 1125;
  TUNE_INT TT_CAPTURE_LMR_SCALAR = 954;
  TUNE_INT GOOD_EVAL_LMR_SCALAR = 1004;
  TUNE_INT GOOD_EVAL_LMR_MARGIN = 314;
  TUNE_INT FUTILITY_LMR_BASE = 169;
  TUNE_INT FUTILITY_LMR_MULT = 82;
  TUNE_INT FUTILITY_LMR_SCALAR = 1000;
  TUNE_INT IMPROVING_LMR_SCALAR = 1069;
  TUNE_INT IMPROVING_FAIL_HIGH_MARGIN = 89;
  TUNE_INT GIVES_CHECK_LMR_SCALAR = 1031;
  TUNE_INT CUT_NODE_LMR_NO_TT_SCALAR = 1010;
  TUNE_INT TT_PV_LMR_PV_NODE_SCALAR = 513;
  TUNE_INT TT_PV_LMR_IMPROVING_SCALAR = 254;  
  TUNE_INT LMR_DEPTH_HIST_MULT = 2000;
  TUNE_INT LMR_DEPTH_HIST_DIVISOR = 16786077;

  /*╔═══════════════════════╗
    ║     Move Ordering     ║
    ╚═══════════════════════╝*/
  TUNE_INT MAIN_HIST_WEIGHT = 977;
  TUNE_INT CONTHIST_1_WEIGHT = 1041;
  TUNE_INT CONTHIST_2_WEIGHT = 1067;
  TUNE_INT CONTHIST_4_WEIGHT = 1078;
  TUNE_INT PAWN_HIST_WEIGHT = 1010;
  TUNE_INT MAIN_HIST_DIVISOR = 1016;
  TUNE_INT CONTHIST_1_DIVISOR = 1068;
  TUNE_INT CONTHIST_2_DIVISOR = 1089;
  TUNE_INT CONTHIST_4_DIVISOR = 1068;
  TUNE_INT PAWN_HIST_DIVISOR = 1127;
  
  
  /*╔═══════════════════════╗
    ║ Late Move Pruning     ║
    ╚═══════════════════════╝*/
  TUNE_INT LMP_BASE = 4167;
  TUNE_INT LMP_MULTIPLIER = 2982;
  TUNE_INT LMP_HIST_LIMIT_NEG = 6229;
  TUNE_INT LMP_HIST_LIMIT_POS = 6146;
  TUNE_INT LMP_HIST_MULT = 255;
  TUNE_INT LMP_HIST_DIVISOR = 17713;

/*╔═════════════╗
  ║   Probcut   ║
  ╚═════════════╝*/
  TUNE_INT PROBCUT_BETA_MARGIN = 151;
  TUNE_INT PROBCUT_DEPTH = 5;
  TUNE_INT PROBCUT_DEPTH_SUBTRACTOR = 4;
  TUNE_INT PROBCUT_IMPROVING_MARGIN = 39;
  TUNE_INT PROBCUT_SEE_NOISY_THRESHOLD = 105;
  TUNE_INT PROBCUT_NOISY_HIST_MULT = 101;
  TUNE_INT PROBCUT_NOISY_HIST_DIVISOR = 1261541;
  TUNE_INT PROBCUT_REDUCTION_MULTIPLIER = 247;
  TUNE_INT PROBCUT_CUTNODE_SCALAR = 989;
  TUNE_INT PROBCUT_FP_BASE = 163;
  TUNE_INT PROBCUT_FP_MULT = 96;


/*╔═══════════════════╗
  ║   Small Probcut   ║
  ╚═══════════════════╝*/
  TUNE_INT SPROBCUT_BETA_MARGIN = 385;
  ...
  /*╔════════════════════╗
    ║ Futility Pruning   ║
    ╚════════════════════╝*/
  TUNE_INT FUTILITY_PRUNING_OFFSET[] = {0, 87, 47, 21, 10, 5};
  TUNE_INT FP_DEPTH = 5;
  TUNE_INT FP_MARGIN = 74;
  TUNE_INT BNFP_MARGIN = 76;
  TUNE_INT QUIET_HISTORY_PRUNING_MARGIN = 1720;
  TUNE_INT FP_HIST_MULT = 476;
  TUNE_INT FP_HIST_DIVISOR = 15065;
  
  
  /*╔══════════════════════════════╗
    ║ Reverse Futility Pruning     ║
    ╚══════════════════════════════╝*/
  TUNE_INT RFP_MARGIN = 54;
  TUNE_INT RFP_IMPROVING_MARGIN = 42;
  TUNE_INT RFP_CORRPLEXITY_MULT = 9213;
  TUNE_INT RFP_CORRPLEXITY_DIVISOR = 501;
  ...
  TUNE_INT RAZORING_FULL_MARGIN = 207;    
  TUNE_INT RAZORING_DEPTH_SCALE = 16;
  ...
  /*╔═════════════════════╗
    ...
    ╚═════════════════════╝*/
  TUNE_INT SE_DEPTH = 5;
  TUNE_INT LDSE_BASE_MARGIN = 21;
  TUNE_INT LDSE_CORRECTION_MULT = 738;
  TUNE_INT LDSE_CORRECTION_DIVISOR = 98035;
  TUNE_INT SE_TT_DEPTH_SUBTRACTOR = 3;
  // Positive Extensions
  TUNE_INT DOUBLE_EXTENSION_MARGIN = -2;
  TUNE_INT TRIPLE_EXTENSION_MARGIN = 40;
  TUNE_INT QUADRUPLE_EXTENSION_MARGIN = 90;
  TUNE_INT MULTI_LOW_DEPTH_EXT_MARGIN = 5;
  TUNE_INT QUADRUPLE_EXT_NOISY_BONUS = 163;
  TUNE_INT SE_CORRECTION_MULT = 1008;
  TUNE_INT SE_CORRECTION_DIVISOR = 2900694;
  // Negative Extensions
  TUNE_INT TRIPLE_EXT_HIST_MULT = 32;
  TUNE_INT TRIPLE_EXT_HIST_DIVISOR = 15796;
  TUNE_INT TRIPLE_EXT_NOISY_BONUS = 77;
  ...
  /*╔══════════════════════════════╗
    ║      Aspiration Windows      ║
    ╚══════════════════════════════╝*/
  TUNE_INT ASP_WINDOW_BASE = 2333;
  TUNE_INT ASP_WINDOW_DIVISOR = 542;
  TUNE_INT ASP_WINDOW_MIN_DEPTH = 4;
  TUNE_DOUBLE ASP_WINDOW_MULTIPLIER = 1.9192253878189796;
...
/*╔═══════════════════════╗
  ...
  TUNE_INT QUIET_HIST_BONUS_DEPTH = 174;
  TUNE_INT QUIET_HIST_BONUS_MAX = 4053;
  TUNE_INT QUIET_HIST_MALUS_BASE = 9;
  TUNE_INT QUIET_HIST_MALUS_DEPTH = 199;
  TUNE_INT QUIET_HIST_FAILED_LOW_BONUS = 220;
  TUNE_INT QUIET_HIST_FAILED_LOW_MALUS = 210;
  TUNE_INT QUIET_HIST_MALUS_MAX = 3955;
  TUNE_INT HISTORY_RED_MULT = 1081;
  TUNE_INT HISTORY_RED_DIVISOR = 16777029;
  TUNE_INT CONTHIST_MULT = 1105;

  // Continuation History
  TUNE_INT CONTHIST_BONUS_BASE = 9;
  TUNE_INT CONTHIST_BONUS_DEPTH = 167;
  TUNE_INT CONTHIST_BONUS_MAX = 3702;
  TUNE_INT CONTHIST_MALUS_BASE = 12;
  TUNE_INT CONTHIST_MALUS_DEPTH = 212;
  TUNE_INT CONTHIST_FAILED_LOW_BONUS = 211;
  TUNE_INT CONTHIST_FAILED_LOW_MALUS = 174;
  TUNE_INT CONTHIST_MALUS_MAX = 4250;

  // Pawn History
  TUNE_INT PAWNHIST_BONUS_BASE = 8;
  TUNE_INT PAWNHIST_BONUS_DEPTH = 213;
  TUNE_INT PAWNHIST_BONUS_MAX = 4139;
  TUNE_INT PAWNHIST_MALUS_BASE = 8;
  TUNE_INT PAWNHIST_MALUS_DEPTH = 235;
  TUNE_INT PAWNHIST_FAILED_LOW_BONUS = 172;
  TUNE_INT PAWNHIST_FAILED_LOW_MALUS = 207;
  TUNE_INT PAWNHIST_MALUS_MAX = 3672;

  // Capture History
  TUNE_INT CAPTHIST_BONUS_BASE = 9;
  TUNE_INT CAPTHIST_BONUS_DEPTH = 195;
  TUNE_INT CAPTHIST_BONUS_MAX = 4081;
  TUNE_INT CAPTHIST_MALUS_BASE = 11;
  TUNE_INT CAPTHIST_MALUS_DEPTH = 236;
  TUNE_INT CAPTHIST_MALUS_MAX = 4159;  

  // Bad Quiet Index Scaling
  TUNE_INT BAD_QUIET_INDEX_SCALE = 25;
...
int negamax(int alpha, int beta, int depth, ThreadData *t, my_time* time, SearchStack *ss, bool predicted_cut_node) {
    ...
    if (!ss->singular_move) {
        ...
        if (!in_check && (bestMove == 0 || !getMoveCapture(bestMove)) &&
            ...
            update_king_shield_corrhist(t, depth, corrhistBonus);
        }
