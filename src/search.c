...
/*╔═══════════════════════════════╗
  ...
  TUNE_INT SEE_MOVE_ORDERING_THRESHOLD = -56;
  TUNE_INT SEE_QUIET_THRESHOLD = -66;
  TUNE_INT SEE_NOISY_THRESHOLD = -34;
  TUNE_INT SEE_DEPTH = 10;
  TUNE_INT MOVE_ORDER_HIST_MULT = 463;
  TUNE_INT SEE_PRUNING_HIST_MULT = 523;
  ...
  TUNE_INT NMP_BASE_REDUCTION = 5207;
  TUNE_INT NMP_DEPTH_MULTIPLIER = 242;
  TUNE_INT NMP_REDUCTION_DEPTH_MULT = 8049;
  TUNE_INT NMP_EVAL_MULT = 124;
  TUNE_INT NMP_FAILED_HIGH_HIST_BASE = 105;
  TUNE_INT NMP_FAILED_HIGH_HIST_MULT = 30030;
  TUNE_INT NMP_FAILED_HIGH_HIST_DIVISOR = 560;
  TUNE_INT NMP_EVAL_BETA_MARGIN = 84;
  TUNE_INT NMP_VERIFICATION_MARGIN = 32;
  TUNE_INT NMP_REDUCTION_DIVISOR = 8402854;
  TUNE_INT NMP_EVAL_DIVISOR = 42999;
  ...
  TUNE_DOUBLE LMR_TABLE_BASE_NOISY = 0.3754064257818328;
  TUNE_DOUBLE LMR_TABLE_NOISY_MULT = 129.00179940939861;
  TUNE_DOUBLE LMR_TABLE_BASE_QUIET = 0.9451767737343365;
  TUNE_DOUBLE LMR_TABLE_QUIET_MULT = 131.93872045203946;
  TUNE_INT LMR_FULL_DEPTH_MOVES = 2;
  TUNE_INT LMR_REDUCTION_LIMIT = 3;
  TUNE_INT DEEPER_LMR_MARGIN = 38;  
  TUNE_INT QUIET_HISTORY_LMR_MULT = 1922;
  TUNE_INT QUIET_HISTORY_LMR_DIVISOR = 8521067;
  TUNE_INT QUIET_HISTORY_LMR_MINIMUM_SCALAR = 3142;
  TUNE_INT QUIET_HISTORY_LMR_MAXIMUM_SCALAR = 3269;
  TUNE_INT PAWN_HISTORY_LMR_MULT = 1323;
  TUNE_INT PAWN_HISTORY_LMR_DIVISOR = 8943194;
  TUNE_INT PAWN_HISTORY_LMR_MINIMUM_SCALAR = 2951;
  TUNE_INT PAWN_HISTORY_LMR_MAXIMUM_SCALAR = 3160;
  TUNE_INT NOISY_HISTORY_LMR_MULT = 106;  
  TUNE_INT NOISY_HISTORY_LMR_DIVISOR = 1314512;
  TUNE_INT QUIET_NON_PV_LMR_SCALAR = 971;
  TUNE_INT CUT_NODE_LMR_SCALAR = 1950;
  TUNE_INT TT_PV_LMR_SCALAR = 1052;
  TUNE_INT TT_PV_FAIL_LOW_LMR_SCALAR = 1153;
  TUNE_INT TT_CAPTURE_LMR_SCALAR = 967;
  TUNE_INT GOOD_EVAL_LMR_SCALAR = 1008;
  TUNE_INT GOOD_EVAL_LMR_MARGIN = 278;
  TUNE_INT FUTILITY_LMR_BASE = 174;
  TUNE_INT FUTILITY_LMR_MULT = 89;
  TUNE_INT FUTILITY_LMR_SCALAR = 963;
  TUNE_INT IMPROVING_LMR_SCALAR = 1088;
  TUNE_INT IMPROVING_FAIL_HIGH_MARGIN = 83;
  TUNE_INT GIVES_CHECK_LMR_SCALAR = 1063;
  TUNE_INT LMR_FUTILITY_OFFSET[] = {0, 164, 82, 41, 20, 10};
  TUNE_INT LMR_DEPTH_HIST_MULT = 2015;
  ...
  TUNE_INT LMP_HIST_MULT = 238;
  TUNE_INT LMP_HIST_DIVISOR = 16719;

/*╔═════════════╗
  ║   Probcut   ║
  ╚═════════════╝*/
  TUNE_INT PROBCUT_BETA_MARGIN = 169;
  TUNE_INT PROBCUT_DEPTH = 5;
  TUNE_INT PROBCUT_DEPTH_SUBTRACTOR = 4;
  TUNE_INT PROBCUT_IMPROVING_MARGIN = 44;
  TUNE_INT PROBCUT_SEE_NOISY_THRESHOLD = 104;
  TUNE_INT PROBCUT_NOISY_HIST_MULT = 99;
...
/*╔═══════════════════╗
  ║   Small Probcut   ║
  ╚═══════════════════╝*/
  TUNE_INT SPROBCUT_BETA_MARGIN = 407;
  ...
  /*╔════════════════════╗
    ║ Futility Pruning   ║
    ╚════════════════════╝*/
  TUNE_INT FUTILITY_PRUNING_OFFSET[] = {0, 94, 42, 20, 11, 6};
  TUNE_INT FP_DEPTH = 5;
  TUNE_INT FP_MARGIN = 78;
  TUNE_INT BNFP_MARGIN = 73;
  TUNE_INT QUIET_HISTORY_PRUNING_MARGIN = 1855;
  TUNE_INT FP_HIST_MULT = 477;
  TUNE_INT FP_HIST_DIVISOR = 15595;
  ...
  TUNE_INT RFP_IMPROVING_MARGIN = 40;
  TUNE_INT RFP_CORRPLEXITY_MULT = 7596;
  TUNE_INT RFP_CORRPLEXITY_DIVISOR = 564;
  ...
  TUNE_INT RAZORING_FULL_MARGIN = 213;    
  TUNE_INT RAZORING_DEPTH_SCALE = 13;
  TUNE_INT RAZORING_VERIFY_MARGIN = 118;
  ...
  TUNE_INT LDSE_CORRECTION_MULT = 734;
  TUNE_INT LDSE_CORRECTION_DIVISOR = 98631;
  ...
  /*╔══════════════════════════════╗
    ║      Aspiration Windows      ║
    ╚══════════════════════════════╝*/
  TUNE_INT ASP_WINDOW_BASE = 2089;
  TUNE_INT ASP_WINDOW_DIVISOR = 510;
  TUNE_INT ASP_WINDOW_MIN_DEPTH = 4;
  TUNE_DOUBLE ASP_WINDOW_MULTIPLIER = 2.0766901330125287;
...
/*╔═══════════════════════╗
  ...
  TUNE_INT QUIET_HIST_BONUS_DEPTH = 159;
  TUNE_INT QUIET_HIST_BONUS_MAX = 4079;
  TUNE_INT QUIET_HIST_MALUS_BASE = 10;
  TUNE_INT QUIET_HIST_MALUS_DEPTH = 194;
  TUNE_INT QUIET_HIST_FAILED_LOW_BONUS = 213;
  TUNE_INT QUIET_HIST_FAILED_LOW_MALUS = 206;
  TUNE_INT QUIET_HIST_MALUS_MAX = 4073;
  TUNE_INT HISTORY_RED_MULT = 1064;
  TUNE_INT HISTORY_RED_DIVISOR = 16845821;
  TUNE_INT CONTHIST_MULT = 1105;

  // Continuation History
  TUNE_INT CONTHIST_BONUS_BASE = 10;
  TUNE_INT CONTHIST_BONUS_DEPTH = 172;
  TUNE_INT CONTHIST_BONUS_MAX = 3708;
  TUNE_INT CONTHIST_MALUS_BASE = 11;
  TUNE_INT CONTHIST_MALUS_DEPTH = 207;
  TUNE_INT CONTHIST_FAILED_LOW_BONUS = 209;
  TUNE_INT CONTHIST_FAILED_LOW_MALUS = 174;
  TUNE_INT CONTHIST_MALUS_MAX = 4191;

  // Pawn History
  TUNE_INT PAWNHIST_BONUS_BASE = 9;
  TUNE_INT PAWNHIST_BONUS_DEPTH = 238;
  TUNE_INT PAWNHIST_BONUS_MAX = 3956;
  TUNE_INT PAWNHIST_MALUS_BASE = 8;
  TUNE_INT PAWNHIST_MALUS_DEPTH = 219;
  TUNE_INT PAWNHIST_FAILED_LOW_BONUS = 174;
  TUNE_INT PAWNHIST_FAILED_LOW_MALUS = 214;
  TUNE_INT PAWNHIST_MALUS_MAX = 3547;

  // Capture History
  TUNE_INT CAPTHIST_BONUS_BASE = 10;
  TUNE_INT CAPTHIST_BONUS_DEPTH = 202;
  TUNE_INT CAPTHIST_BONUS_MAX = 4114;
  TUNE_INT CAPTHIST_MALUS_BASE = 14;
  TUNE_INT CAPTHIST_MALUS_DEPTH = 239;
  TUNE_INT CAPTHIST_MALUS_MAX = 4178;  
