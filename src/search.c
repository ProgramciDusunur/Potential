...
/*╔═══════════════════════════════╗
  ...
  TUNE_DOUBLE LMR_TABLE_BASE_NOISY = 0.3800;
  TUNE_DOUBLE LMR_TABLE_NOISY_MULT = 128.0000;
  TUNE_DOUBLE LMR_TABLE_BASE_QUIET = 1.0100;
  TUNE_DOUBLE LMR_TABLE_QUIET_MULT = 128.0000;
