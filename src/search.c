...
/*╔═══════════════════════════════╗
  ...
  TUNE_INT QS_SEE_THRESHOLD = 0;
  TUNE_INT SEE_MOVE_ORDERING_THRESHOLD = -82;
  TUNE_INT SEE_QUIET_THRESHOLD = -67;
  TUNE_INT SEE_NOISY_THRESHOLD = -32;
  TUNE_INT SEE_DEPTH = 10;
  TUNE_INT MOVE_ORDER_HIST_MULT = 512;
  TUNE_INT SEE_PRUNING_HIST_MULT = 512;
  ...
  TUNE_DOUBLE LMR_TABLE_BASE_NOISY = 0.38;
  TUNE_DOUBLE LMR_TABLE_NOISY_MULT = 128.0;
  TUNE_DOUBLE LMR_TABLE_BASE_QUIET = 1.01;
  TUNE_DOUBLE LMR_TABLE_QUIET_MULT = 128.0;
  ...
  TUNE_INT NOISY_HISTORY_LMR_DIVISOR = 1310720;
  TUNE_INT QUIET_NON_PV_LMR_SCALAR = 1024;
  TUNE_INT CUT_NODE_LMR_SCALAR = 2048;
  TUNE_INT TT_PV_LMR_SCALAR = 1024;
  TUNE_INT TT_PV_FAIL_LOW_LMR_SCALAR = 1024;
  TUNE_INT TT_CAPTURE_LMR_SCALAR = 1024;
  TUNE_INT GOOD_EVAL_LMR_SCALAR = 1024;
  TUNE_INT GOOD_EVAL_LMR_MARGIN = 365;
  TUNE_INT FUTILITY_LMR_BASE = 164;
  TUNE_INT FUTILITY_LMR_MULT = 82;
  TUNE_INT FUTILITY_LMR_SCALAR = 1024;
  TUNE_INT IMPROVING_LMR_SCALAR = 1024;
  TUNE_INT IMPROVING_FAIL_HIGH_MARGIN = 100;
  TUNE_INT GIVES_CHECK_LMR_SCALAR = 1024;
  TUNE_INT LMR_FUTILITY_OFFSET[] = {0, 164, 82, 41, 20, 10};
  TUNE_INT LMR_DEPTH_HIST_MULT = 2048;
  ...
  TUNE_INT LMP_HIST_MULT = 256;
  TUNE_INT LMP_HIST_DIVISOR = 16384;

/*╔═════════════╗
  ║   Probcut   ║
  ╚═════════════╝*/
  TUNE_INT PROBCUT_BETA_MARGIN = 150;
  TUNE_INT PROBCUT_DEPTH = 5;
  TUNE_INT PROBCUT_DEPTH_SUBTRACTOR = 4;
  TUNE_INT PROBCUT_IMPROVING_MARGIN = 30;
  TUNE_INT PROBCUT_SEE_NOISY_THRESHOLD = 100;
  TUNE_INT PROBCUT_NOISY_HIST_MULT = 128;
  TUNE_INT PROBCUT_FP_BASE = 164;
...
/*╔═══════════════════╗
  ║   Small Probcut   ║
  ╚═══════════════════╝*/
  TUNE_INT SPROBCUT_BETA_MARGIN = 350;
  ...
  /*╔════════════════════╗
    ║ Futility Pruning   ║
    ╚════════════════════╝*/
  TUNE_INT FUTILITY_PRUNING_OFFSET[] = {0, 82, 41, 20, 10, 5};
  TUNE_INT FP_DEPTH = 5;
  TUNE_INT FP_MARGIN = 82;
  TUNE_INT BNFP_MARGIN = 71;
  TUNE_INT QUIET_HISTORY_PRUNING_MARGIN = 2048;
  TUNE_INT FP_HIST_MULT = 512;
  TUNE_INT FP_HIST_DIVISOR = 16384;
  ...
  TUNE_INT RAZORING_FULL_MARGIN = 200;    
  ...
  TUNE_INT LDSE_CORRECTION_MULT = 768;
  TUNE_INT LDSE_CORRECTION_DIVISOR = 98304;
  ...
  TUNE_DOUBLE ASP_WINDOW_MULTIPLIER = 1.8;
...
/*╔═══════════════════════╗
  ...
  TUNE_INT QUIET_HIST_BONUS_DEPTH = 200;
  TUNE_INT QUIET_HIST_BONUS_MAX = 4096;
  TUNE_INT QUIET_HIST_MALUS_BASE = 10;
  TUNE_INT QUIET_HIST_MALUS_DEPTH = 200;
  TUNE_INT QUIET_HIST_FAILED_LOW_BONUS = 200;
  TUNE_INT QUIET_HIST_FAILED_LOW_MALUS = 200;
  TUNE_INT QUIET_HIST_MALUS_MAX = 4096;
  TUNE_INT HISTORY_RED_MULT = 1024;
  TUNE_INT HISTORY_RED_DIVISOR = 16777216;
  TUNE_INT CONTHIST_MULT = 1024;

  // Continuation History
  TUNE_INT CONTHIST_BONUS_BASE = 10;
  TUNE_INT CONTHIST_BONUS_DEPTH = 200;
  TUNE_INT CONTHIST_BONUS_MAX = 4096;
  TUNE_INT CONTHIST_MALUS_BASE = 10;
  TUNE_INT CONTHIST_MALUS_DEPTH = 200;
  TUNE_INT CONTHIST_FAILED_LOW_BONUS = 200;
  TUNE_INT CONTHIST_FAILED_LOW_MALUS = 200;
  TUNE_INT CONTHIST_MALUS_MAX = 4096;

  // Pawn History
  TUNE_INT PAWNHIST_BONUS_BASE = 10;
  TUNE_INT PAWNHIST_BONUS_DEPTH = 200;
  TUNE_INT PAWNHIST_BONUS_MAX = 4096;
  TUNE_INT PAWNHIST_MALUS_BASE = 10;
  TUNE_INT PAWNHIST_MALUS_DEPTH = 200;
  TUNE_INT PAWNHIST_FAILED_LOW_BONUS = 200;
  TUNE_INT PAWNHIST_FAILED_LOW_MALUS = 200;
  TUNE_INT PAWNHIST_MALUS_MAX = 4096;

  // Capture History
  TUNE_INT CAPTHIST_BONUS_BASE = 10;
  TUNE_INT CAPTHIST_BONUS_DEPTH = 200;
  TUNE_INT CAPTHIST_BONUS_MAX = 4096;
  TUNE_INT CAPTHIST_MALUS_BASE = 10;
  TUNE_INT CAPTHIST_MALUS_DEPTH = 200;
  TUNE_INT CAPTHIST_MALUS_MAX = 4096;  
