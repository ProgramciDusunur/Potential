...
/*╔═══════════════════════════════╗
  ...
  TUNE_INT MOVE_ORDER_HIST_MULT = 474;
  TUNE_INT SEE_PRUNING_HIST_MULT = 531;
  TUNE_INT SEE_QUIET_HIST_MULT = 154;
  ...
  TUNE_INT NMP_BASE_REDUCTION = 5124;
  TUNE_INT NMP_DEPTH_MULTIPLIER = 259;
  TUNE_INT NMP_REDUCTION_DEPTH_MULT = 10765;
  TUNE_INT NMP_EVAL_MULT = 126;
  TUNE_INT NMP_FAILED_HIGH_HIST_BASE = 85;
  TUNE_INT NMP_FAILED_HIGH_HIST_MULT = 29448;
  TUNE_INT NMP_FAILED_HIGH_HIST_DIVISOR = 545;
  TUNE_INT NMP_EVAL_BETA_MARGIN = 32;
  TUNE_INT NMP_VERIFICATION_MARGIN = 27;
  TUNE_INT NMP_REDUCTION_DIVISOR = 8198760;
  TUNE_INT NMP_EVAL_DIVISOR = 53195;
  ...
  TUNE_DOUBLE LMR_TABLE_BASE_NOISY = 0.3949292152051395;
  TUNE_DOUBLE LMR_TABLE_NOISY_MULT = 132.9168479342405;
  TUNE_DOUBLE LMR_TABLE_BASE_QUIET = 0.9867312690302927;
  TUNE_DOUBLE LMR_TABLE_QUIET_MULT = 144.78648577926762;
  TUNE_INT LMR_FULL_DEPTH_MOVES = 2;
  TUNE_INT LMR_REDUCTION_LIMIT = 3;
  TUNE_INT DEEPER_LMR_MARGIN = 41;  
  TUNE_INT QUIET_HISTORY_LMR_MULT = 2463;
  TUNE_INT QUIET_HISTORY_LMR_DIVISOR = 8841419;
  TUNE_INT QUIET_HISTORY_LMR_MINIMUM_SCALAR = 3168;
  TUNE_INT QUIET_HISTORY_LMR_MAXIMUM_SCALAR = 3309;
  TUNE_INT PAWN_HISTORY_LMR_MULT = 1597;
  TUNE_INT PAWN_HISTORY_LMR_DIVISOR = 9852218;
  TUNE_INT PAWN_HISTORY_LMR_MINIMUM_SCALAR = 2910;
  TUNE_INT PAWN_HISTORY_LMR_MAXIMUM_SCALAR = 2956;
  TUNE_INT NOISY_HISTORY_LMR_MULT = 119;  
  TUNE_INT NOISY_HISTORY_LMR_DIVISOR = 1297284;
  TUNE_INT QUIET_NON_PV_LMR_SCALAR = 1098;
  TUNE_INT CUT_NODE_LMR_SCALAR = 1997;
  TUNE_INT TT_PV_LMR_SCALAR = 1046;
  TUNE_INT TT_PV_FAIL_LOW_LMR_SCALAR = 1072;
  TUNE_INT TT_CAPTURE_LMR_SCALAR = 1049;
  TUNE_INT GOOD_EVAL_LMR_SCALAR = 1068;
  TUNE_INT GOOD_EVAL_LMR_MARGIN = 300;
  TUNE_INT FUTILITY_LMR_BASE = 176;
  TUNE_INT FUTILITY_LMR_MULT = 84;
  TUNE_INT FUTILITY_LMR_SCALAR = 973;
  TUNE_INT IMPROVING_LMR_SCALAR = 1069;
  TUNE_INT IMPROVING_FAIL_HIGH_MARGIN = 88;
  TUNE_INT GIVES_CHECK_LMR_SCALAR = 998;
  TUNE_INT LMR_FUTILITY_OFFSET[] = {0, 164, 82, 41, 20, 10};
  TUNE_INT LMR_DEPTH_HIST_MULT = 2061;
  ...
  TUNE_INT LMP_HIST_MULT = 229;
  TUNE_INT LMP_HIST_DIVISOR = 17367;

/*╔═════════════╗
  ║   Probcut   ║
  ╚═════════════╝*/
  TUNE_INT PROBCUT_BETA_MARGIN = 135;
  TUNE_INT PROBCUT_DEPTH = 5;
  TUNE_INT PROBCUT_DEPTH_SUBTRACTOR = 4;
  TUNE_INT PROBCUT_IMPROVING_MARGIN = 40;
  TUNE_INT PROBCUT_SEE_NOISY_THRESHOLD = 89;
  TUNE_INT PROBCUT_NOISY_HIST_MULT = 113;
  TUNE_INT PROBCUT_FP_BASE = 157;
  TUNE_INT PROBCUT_FP_MULT = 103;


/*╔═══════════════════╗
  ║   Small Probcut   ║
  ╚═══════════════════╝*/
  TUNE_INT SPROBCUT_BETA_MARGIN = 413;
  ...
  /*╔════════════════════╗
    ║ Futility Pruning   ║
    ╚════════════════════╝*/
  TUNE_INT FUTILITY_PRUNING_OFFSET[] = {0, 78, 46, 20, 10, 5};
  TUNE_INT FP_DEPTH = 5;
  TUNE_INT FP_MARGIN = 63;
  TUNE_INT BNFP_MARGIN = 77;
  TUNE_INT QUIET_HISTORY_PRUNING_MARGIN = 1676;
  TUNE_INT FP_HIST_MULT = 419;
  TUNE_INT FP_HIST_DIVISOR = 16305;
  ...
  TUNE_INT RFP_IMPROVING_MARGIN = 39;
  TUNE_INT RFP_CORRPLEXITY_MULT = 10154;
  TUNE_INT RFP_CORRPLEXITY_DIVISOR = 375;
  ...
  TUNE_INT RAZORING_FULL_MARGIN = 226;    
  TUNE_INT RAZORING_DEPTH_SCALE = 16;
  TUNE_INT RAZORING_VERIFY_MARGIN = 141;
  ...
  /*╔═════════════════════╗
    ...
    ╚═════════════════════╝*/
  TUNE_INT SE_DEPTH = 5;
  TUNE_INT LDSE_BASE_MARGIN = 30;
  TUNE_INT LDSE_CORRECTION_MULT = 700;
  TUNE_INT LDSE_CORRECTION_DIVISOR = 100453;
  ...
  /*╔══════════════════════════════╗
    ║      Aspiration Windows      ║
    ╚══════════════════════════════╝*/
  TUNE_INT ASP_WINDOW_BASE = 2667;
  TUNE_INT ASP_WINDOW_DIVISOR = 414;
  TUNE_INT ASP_WINDOW_MIN_DEPTH = 4;
  TUNE_DOUBLE ASP_WINDOW_MULTIPLIER = 2.051292310353398;
...
/*╔═══════════════════════╗
  ...
  TUNE_INT QUIET_HIST_BONUS_DEPTH = 201;
  TUNE_INT QUIET_HIST_BONUS_MAX = 4244;
  TUNE_INT QUIET_HIST_MALUS_BASE = 10;
  TUNE_INT QUIET_HIST_MALUS_DEPTH = 181;
  TUNE_INT QUIET_HIST_FAILED_LOW_BONUS = 207;
  TUNE_INT QUIET_HIST_FAILED_LOW_MALUS = 209;
  TUNE_INT QUIET_HIST_MALUS_MAX = 4012;
  TUNE_INT HISTORY_RED_MULT = 948;
  TUNE_INT HISTORY_RED_DIVISOR = 16718377;
  TUNE_INT CONTHIST_MULT = 1063;

  // Continuation History
  TUNE_INT CONTHIST_BONUS_BASE = 8;
  TUNE_INT CONTHIST_BONUS_DEPTH = 156;
  TUNE_INT CONTHIST_BONUS_MAX = 3913;
  TUNE_INT CONTHIST_MALUS_BASE = 13;
  TUNE_INT CONTHIST_MALUS_DEPTH = 212;
  TUNE_INT CONTHIST_FAILED_LOW_BONUS = 219;
  TUNE_INT CONTHIST_FAILED_LOW_MALUS = 200;
  TUNE_INT CONTHIST_MALUS_MAX = 4100;

  // Pawn History
  TUNE_INT PAWNHIST_BONUS_BASE = 10;
  TUNE_INT PAWNHIST_BONUS_DEPTH = 210;
  TUNE_INT PAWNHIST_BONUS_MAX = 4023;
  TUNE_INT PAWNHIST_MALUS_BASE = 9;
  TUNE_INT PAWNHIST_MALUS_DEPTH = 210;
  TUNE_INT PAWNHIST_FAILED_LOW_BONUS = 150;
  TUNE_INT PAWNHIST_FAILED_LOW_MALUS = 195;
  TUNE_INT PAWNHIST_MALUS_MAX = 4168;

  // Capture History
  TUNE_INT CAPTHIST_BONUS_BASE = 12;
  TUNE_INT CAPTHIST_BONUS_DEPTH = 171;
  TUNE_INT CAPTHIST_BONUS_MAX = 3796;
  TUNE_INT CAPTHIST_MALUS_BASE = 13;
  TUNE_INT CAPTHIST_MALUS_DEPTH = 245;
  TUNE_INT CAPTHIST_MALUS_MAX = 4457;  
