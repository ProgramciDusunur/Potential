...
/*╔═══════════════════════════════╗
  ...
  TUNE_INT SEE_MOVE_ORDERING_THRESHOLD = -58;
  TUNE_INT SEE_QUIET_THRESHOLD = -65;
  TUNE_INT SEE_NOISY_THRESHOLD = -35;
  TUNE_INT SEE_DEPTH = 10;
  TUNE_INT MOVE_ORDER_HIST_MULT = 484;
  TUNE_INT SEE_PRUNING_HIST_MULT = 517;
  TUNE_INT SEE_QUIET_HIST_MULT = 121;
  TUNE_INT SEE_QUIET_HIST_DIVISOR = 12151;
  ...
  TUNE_INT NMP_BASE_REDUCTION = 5196;
  TUNE_INT NMP_DEPTH_MULTIPLIER = 249;
  TUNE_INT NMP_REDUCTION_DEPTH_MULT = 8656;
  TUNE_INT NMP_EVAL_MULT = 134;
  TUNE_INT NMP_FAILED_HIGH_HIST_BASE = 99;
  TUNE_INT NMP_FAILED_HIGH_HIST_MULT = 27375;
  TUNE_INT NMP_FAILED_HIGH_HIST_DIVISOR = 570;
  TUNE_INT NMP_EVAL_BETA_MARGIN = 78;
  TUNE_INT NMP_VERIFICATION_MARGIN = 32;
  TUNE_INT NMP_REDUCTION_DIVISOR = 8384582;
  TUNE_INT NMP_EVAL_DIVISOR = 47325;
  ...
  TUNE_DOUBLE LMR_TABLE_BASE_NOISY = 0.39301542458226624;
  TUNE_DOUBLE LMR_TABLE_NOISY_MULT = 135.9033709530449;
  TUNE_DOUBLE LMR_TABLE_BASE_QUIET = 0.9729993598567906;
  TUNE_DOUBLE LMR_TABLE_QUIET_MULT = 131.87158826785478;
  TUNE_INT LMR_FULL_DEPTH_MOVES = 2;
  TUNE_INT LMR_REDUCTION_LIMIT = 3;
  TUNE_INT DEEPER_LMR_MARGIN = 35;  
  TUNE_INT QUIET_HISTORY_LMR_MULT = 1649;
  TUNE_INT QUIET_HISTORY_LMR_DIVISOR = 7782401;
  TUNE_INT QUIET_HISTORY_LMR_MINIMUM_SCALAR = 3185;
  TUNE_INT QUIET_HISTORY_LMR_MAXIMUM_SCALAR = 3112;
  TUNE_INT PAWN_HISTORY_LMR_MULT = 1135;
  TUNE_INT PAWN_HISTORY_LMR_DIVISOR = 8800971;
  TUNE_INT PAWN_HISTORY_LMR_MINIMUM_SCALAR = 2969;
  TUNE_INT PAWN_HISTORY_LMR_MAXIMUM_SCALAR = 3115;
  TUNE_INT NOISY_HISTORY_LMR_MULT = 106;  
  TUNE_INT NOISY_HISTORY_LMR_DIVISOR = 1313958;
  TUNE_INT QUIET_NON_PV_LMR_SCALAR = 1003;
  TUNE_INT CUT_NODE_LMR_SCALAR = 1881;
  TUNE_INT TT_PV_LMR_SCALAR = 1065;
  TUNE_INT TT_PV_FAIL_LOW_LMR_SCALAR = 1094;
  TUNE_INT TT_CAPTURE_LMR_SCALAR = 981;
  TUNE_INT GOOD_EVAL_LMR_SCALAR = 1010;
  TUNE_INT GOOD_EVAL_LMR_MARGIN = 316;
  TUNE_INT FUTILITY_LMR_BASE = 172;
  TUNE_INT FUTILITY_LMR_MULT = 83;
  TUNE_INT FUTILITY_LMR_SCALAR = 986;
  TUNE_INT IMPROVING_LMR_SCALAR = 1084;
  TUNE_INT IMPROVING_FAIL_HIGH_MARGIN = 88;
  TUNE_INT GIVES_CHECK_LMR_SCALAR = 1084;
  TUNE_INT CUT_NODE_LMR_NO_TT_SCALAR = 1009;
  TUNE_INT TT_PV_LMR_PV_NODE_SCALAR = 1068;
  TUNE_INT TT_PV_LMR_IMPROVING_SCALAR = 1047;  
  TUNE_INT LMR_DEPTH_HIST_MULT = 2040;
  TUNE_INT LMR_DEPTH_HIST_DIVISOR = 16807641;

  /*╔═══════════════════════╗
    ║     Move Ordering     ║
    ╚═══════════════════════╝*/
  TUNE_INT MAIN_HIST_WEIGHT = 1072;
  TUNE_INT CONTHIST_1_WEIGHT = 1096;
  TUNE_INT CONTHIST_2_WEIGHT = 993;
  TUNE_INT CONTHIST_4_WEIGHT = 1071;
  TUNE_INT PAWN_HIST_WEIGHT = 1012;
  TUNE_INT MAIN_HIST_DIVISOR = 1038;
  TUNE_INT CONTHIST_1_DIVISOR = 1092;
  TUNE_INT CONTHIST_2_DIVISOR = 1074;
  TUNE_INT CONTHIST_4_DIVISOR = 1173;
  TUNE_INT PAWN_HIST_DIVISOR = 1007;
  
  
  /*╔═══════════════════════╗
    ║ Late Move Pruning     ║
    ╚═══════════════════════╝*/
  TUNE_INT LMP_BASE = 4134;
  TUNE_INT LMP_MULTIPLIER = 3081;
  TUNE_INT LMP_HIST_LIMIT = 5958;
  TUNE_INT LMP_HIST_MULT = 265;
  TUNE_INT LMP_HIST_DIVISOR = 16661;

/*╔═════════════╗
  ║   Probcut   ║
  ╚═════════════╝*/
  TUNE_INT PROBCUT_BETA_MARGIN = 145;
  TUNE_INT PROBCUT_DEPTH = 5;
  TUNE_INT PROBCUT_DEPTH_SUBTRACTOR = 4;
  TUNE_INT PROBCUT_IMPROVING_MARGIN = 36;
  TUNE_INT PROBCUT_SEE_NOISY_THRESHOLD = 99;
  TUNE_INT PROBCUT_NOISY_HIST_MULT = 96;
  TUNE_INT PROBCUT_NOISY_HIST_DIVISOR = 1306332;
  TUNE_INT PROBCUT_REDUCTION_MULTIPLIER = 261;
  TUNE_INT PROBCUT_CUTNODE_SCALAR = 1026;
  TUNE_INT PROBCUT_FP_BASE = 171;
...
/*╔═══════════════════╗
  ║   Small Probcut   ║
  ╚═══════════════════╝*/
  TUNE_INT SPROBCUT_BETA_MARGIN = 375;
  ...
  /*╔════════════════════╗
    ║ Futility Pruning   ║
    ╚════════════════════╝*/
  TUNE_INT FUTILITY_PRUNING_OFFSET[] = {0, 89, 45, 21, 10, 5};
  TUNE_INT FP_DEPTH = 5;
  TUNE_INT FP_MARGIN = 74;
  TUNE_INT BNFP_MARGIN = 80;
  TUNE_INT QUIET_HISTORY_PRUNING_MARGIN = 1753;
  TUNE_INT FP_HIST_MULT = 456;
  TUNE_INT FP_HIST_DIVISOR = 15851;
  
  
  /*╔══════════════════════════════╗
    ║ Reverse Futility Pruning     ║
    ╚══════════════════════════════╝*/
  TUNE_INT RFP_MARGIN = 53;
  TUNE_INT RFP_IMPROVING_MARGIN = 43;
  TUNE_INT RFP_CORRPLEXITY_MULT = 9887;
  TUNE_INT RFP_CORRPLEXITY_DIVISOR = 529;
  ...
  TUNE_INT RAZORING_FULL_MARGIN = 206;    
  TUNE_INT RAZORING_DEPTH_SCALE = 15;
  TUNE_INT RAZORING_VERIFY_MARGIN = 125;
  ...
  TUNE_INT LDSE_CORRECTION_MULT = 753;
  TUNE_INT LDSE_CORRECTION_DIVISOR = 99117;
  TUNE_INT SE_TT_DEPTH_SUBTRACTOR = 3;
  // Positive Extensions
  TUNE_INT DOUBLE_EXTENSION_MARGIN = -9;
  TUNE_INT TRIPLE_EXTENSION_MARGIN = 40;
  TUNE_INT QUADRUPLE_EXTENSION_MARGIN = 81;
  TUNE_INT MULTI_LOW_DEPTH_EXT_MARGIN = -2;
  TUNE_INT QUADRUPLE_EXT_NOISY_BONUS = 158;
  TUNE_INT SE_CORRECTION_MULT = 974;
  TUNE_INT SE_CORRECTION_DIVISOR = 2948009;
  // Negative Extensions
  TUNE_INT TRIPLE_EXT_HIST_MULT = 32;
  TUNE_INT TRIPLE_EXT_HIST_DIVISOR = 17242;
  TUNE_INT TRIPLE_EXT_NOISY_BONUS = 87;
  ...
  /*╔══════════════════════════════╗
    ║      Aspiration Windows      ║
    ╚══════════════════════════════╝*/
  TUNE_INT ASP_WINDOW_BASE = 2781;
  TUNE_INT ASP_WINDOW_DIVISOR = 535;
  TUNE_INT ASP_WINDOW_MIN_DEPTH = 4;
  TUNE_DOUBLE ASP_WINDOW_MULTIPLIER = 1.8656128110188863;
...
/*╔═══════════════════════╗
  ...
  // Quiet History
  TUNE_INT QUIET_HIST_BONUS_BASE = 9;
  TUNE_INT QUIET_HIST_BONUS_DEPTH = 186;
  TUNE_INT QUIET_HIST_BONUS_MAX = 4089;
  TUNE_INT QUIET_HIST_MALUS_BASE = 9;
  TUNE_INT QUIET_HIST_MALUS_DEPTH = 195;
  TUNE_INT QUIET_HIST_FAILED_LOW_BONUS = 215;
  TUNE_INT QUIET_HIST_FAILED_LOW_MALUS = 208;
  TUNE_INT QUIET_HIST_MALUS_MAX = 4094;
  TUNE_INT HISTORY_RED_MULT = 1045;
  TUNE_INT HISTORY_RED_DIVISOR = 16871861;
  TUNE_INT CONTHIST_MULT = 1085;

  // Continuation History
  TUNE_INT CONTHIST_BONUS_BASE = 9;
  TUNE_INT CONTHIST_BONUS_DEPTH = 169;
  TUNE_INT CONTHIST_BONUS_MAX = 3785;
  TUNE_INT CONTHIST_MALUS_BASE = 12;
  TUNE_INT CONTHIST_MALUS_DEPTH = 226;
  TUNE_INT CONTHIST_FAILED_LOW_BONUS = 209;
  TUNE_INT CONTHIST_FAILED_LOW_MALUS = 177;
  TUNE_INT CONTHIST_MALUS_MAX = 4251;

  // Pawn History
  TUNE_INT PAWNHIST_BONUS_BASE = 10;
  TUNE_INT PAWNHIST_BONUS_DEPTH = 213;
  TUNE_INT PAWNHIST_BONUS_MAX = 4172;
  TUNE_INT PAWNHIST_MALUS_BASE = 9;
  TUNE_INT PAWNHIST_MALUS_DEPTH = 235;
  TUNE_INT PAWNHIST_FAILED_LOW_BONUS = 181;
  TUNE_INT PAWNHIST_FAILED_LOW_MALUS = 200;
  TUNE_INT PAWNHIST_MALUS_MAX = 3768;

  // Capture History
  TUNE_INT CAPTHIST_BONUS_BASE = 9;
  TUNE_INT CAPTHIST_BONUS_DEPTH = 195;
  TUNE_INT CAPTHIST_BONUS_MAX = 4099;
  TUNE_INT CAPTHIST_MALUS_BASE = 12;
  TUNE_INT CAPTHIST_MALUS_DEPTH = 239;
  TUNE_INT CAPTHIST_MALUS_MAX = 4186;  

  // Bad Quiet Index Scaling
  TUNE_INT BAD_QUIET_INDEX_SCALE = 27;
