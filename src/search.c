...
int scoreMove(int move, board* position) {
    ...
    if (getMoveCapture(move)) {
        ...
        captureScore += captureHistory[getMovePiece(move)][getMoveTarget(move)][position->mailbox[getMoveTarget(move)]][is_square_threatened(position, getMoveSource(move))][is_square_threatened(position, getMoveTarget(move))];
