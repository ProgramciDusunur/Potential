...
/*╔═══════════════════════════════╗
  ...
  TUNE_INT NMP_BASE_REDUCTION = 5161;
  TUNE_INT NMP_DEPTH_MULTIPLIER = 253;
  TUNE_INT NMP_REDUCTION_DEPTH_MULT = 8254;
  TUNE_INT NMP_EVAL_MULT = 130;
  TUNE_INT NMP_FAILED_HIGH_HIST_BASE = 99;
  TUNE_INT NMP_FAILED_HIGH_HIST_MULT = 28913;
  TUNE_INT NMP_FAILED_HIGH_HIST_DIVISOR = 548;
  TUNE_INT NMP_EVAL_BETA_MARGIN = 79;
  TUNE_INT NMP_VERIFICATION_MARGIN = 30;
  TUNE_INT NMP_REDUCTION_DIVISOR = 8311886;
  TUNE_INT NMP_EVAL_DIVISOR = 47369;
  ...
  TUNE_DOUBLE LMR_TABLE_BASE_NOISY = 0.3823922091988891;
  TUNE_DOUBLE LMR_TABLE_NOISY_MULT = 131.97109521413975;
  TUNE_DOUBLE LMR_TABLE_BASE_QUIET = 0.9905532666670359;
  TUNE_DOUBLE LMR_TABLE_QUIET_MULT = 128.73672916932676;
  TUNE_INT LMR_FULL_DEPTH_MOVES = 2;
  TUNE_INT LMR_REDUCTION_LIMIT = 3;
  TUNE_INT DEEPER_LMR_MARGIN = 36;  
  TUNE_INT QUIET_HISTORY_LMR_MULT = 1873;
  TUNE_INT QUIET_HISTORY_LMR_DIVISOR = 8128799;
  TUNE_INT QUIET_HISTORY_LMR_MINIMUM_SCALAR = 3197;
  TUNE_INT QUIET_HISTORY_LMR_MAXIMUM_SCALAR = 3226;
  TUNE_INT PAWN_HISTORY_LMR_MULT = 1117;
  TUNE_INT PAWN_HISTORY_LMR_DIVISOR = 8718261;
  TUNE_INT PAWN_HISTORY_LMR_MINIMUM_SCALAR = 2989;
  TUNE_INT PAWN_HISTORY_LMR_MAXIMUM_SCALAR = 3116;
  TUNE_INT NOISY_HISTORY_LMR_MULT = 107;  
  TUNE_INT NOISY_HISTORY_LMR_DIVISOR = 1314544;
  TUNE_INT QUIET_NON_PV_LMR_SCALAR = 986;
  TUNE_INT CUT_NODE_LMR_SCALAR = 1934;
  TUNE_INT TT_PV_LMR_SCALAR = 1069;
  TUNE_INT TT_PV_FAIL_LOW_LMR_SCALAR = 1106;
  TUNE_INT TT_CAPTURE_LMR_SCALAR = 972;
  TUNE_INT GOOD_EVAL_LMR_SCALAR = 994;
  TUNE_INT GOOD_EVAL_LMR_MARGIN = 311;
  TUNE_INT FUTILITY_LMR_BASE = 168;
  TUNE_INT FUTILITY_LMR_MULT = 81;
  TUNE_INT FUTILITY_LMR_SCALAR = 967;
...
/*╔═════════════╗
  ║   Probcut   ║
  ╚═════════════╝*/
  TUNE_INT PROBCUT_BETA_MARGIN = 152;
...
/*╔═══════════════════╗
  ║   Small Probcut   ║
  ╚═══════════════════╝*/
  TUNE_INT SPROBCUT_BETA_MARGIN = 394;
  ...
  /*╔════════════════════╗
    ║ Futility Pruning   ║
    ╚════════════════════╝*/
  TUNE_INT FUTILITY_PRUNING_OFFSET[] = {0, 88, 46, 21, 10, 5};
  TUNE_INT FP_DEPTH = 5;
  TUNE_INT FP_MARGIN = 73;
  TUNE_INT BNFP_MARGIN = 78;
  TUNE_INT QUIET_HISTORY_PRUNING_MARGIN = 1763;
  TUNE_INT FP_HIST_MULT = 489;
  TUNE_INT FP_HIST_DIVISOR = 15486;
  ...
  TUNE_INT RFP_CORRPLEXITY_MULT = 9467;
  TUNE_INT RFP_CORRPLEXITY_DIVISOR = 506;
  ...
  TUNE_INT RAZORING_FULL_MARGIN = 209;    
  ...
  /*╔═════════════════════╗
    ...
    ╚═════════════════════╝*/
  TUNE_INT SE_DEPTH = 5;
  TUNE_INT LDSE_BASE_MARGIN = 20;
  TUNE_INT LDSE_CORRECTION_MULT = 733;
  TUNE_INT LDSE_CORRECTION_DIVISOR = 98643;
  ...
  /*╔══════════════════════════════╗
    ║      Aspiration Windows      ║
    ╚══════════════════════════════╝*/
  TUNE_INT ASP_WINDOW_BASE = 2078;
  TUNE_INT ASP_WINDOW_DIVISOR = 573;
  TUNE_INT ASP_WINDOW_MIN_DEPTH = 4;
  TUNE_DOUBLE ASP_WINDOW_MULTIPLIER = 1.9590951422792378;
...
/*╔═══════════════════════╗
  ...
  TUNE_INT QUIET_HIST_MALUS_MAX = 3954;
  TUNE_INT HISTORY_RED_MULT = 1045;
  TUNE_INT HISTORY_RED_DIVISOR = 16803645;
  TUNE_INT CONTHIST_MULT = 1098;

  // Continuation History
  TUNE_INT CONTHIST_BONUS_BASE = 9;
  TUNE_INT CONTHIST_BONUS_DEPTH = 164;
  TUNE_INT CONTHIST_BONUS_MAX = 3781;
  TUNE_INT CONTHIST_MALUS_BASE = 12;
  TUNE_INT CONTHIST_MALUS_DEPTH = 216;
  TUNE_INT CONTHIST_FAILED_LOW_BONUS = 203;
  TUNE_INT CONTHIST_FAILED_LOW_MALUS = 175;
  TUNE_INT CONTHIST_MALUS_MAX = 4250;

  // Pawn History
  TUNE_INT PAWNHIST_BONUS_BASE = 9;
  TUNE_INT PAWNHIST_BONUS_DEPTH = 220;
  TUNE_INT PAWNHIST_BONUS_MAX = 4110;
  TUNE_INT PAWNHIST_MALUS_BASE = 8;
  TUNE_INT PAWNHIST_MALUS_DEPTH = 228;
  TUNE_INT PAWNHIST_FAILED_LOW_BONUS = 175;
  TUNE_INT PAWNHIST_FAILED_LOW_MALUS = 206;
  TUNE_INT PAWNHIST_MALUS_MAX = 3742;

  // Capture History
  TUNE_INT CAPTHIST_BONUS_BASE = 9;
  TUNE_INT CAPTHIST_BONUS_DEPTH = 192;
  TUNE_INT CAPTHIST_BONUS_MAX = 4079;
  TUNE_INT CAPTHIST_MALUS_BASE = 12;
  TUNE_INT CAPTHIST_MALUS_DEPTH = 241;
  TUNE_INT CAPTHIST_MALUS_MAX = 4225;  
