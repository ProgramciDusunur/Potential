...
/*╔═══════════════════════════════╗
  ...
  TUNE_INT QS_SEE_THRESHOLD = -1;
  TUNE_INT SEE_MOVE_ORDERING_THRESHOLD = -71;
  TUNE_INT SEE_QUIET_THRESHOLD = -68;
  TUNE_INT SEE_NOISY_THRESHOLD = -26;
  TUNE_INT SEE_DEPTH = 10;
  TUNE_INT MOVE_ORDER_HIST_MULT = 492;
  TUNE_INT SEE_PRUNING_HIST_MULT = 517;
  TUNE_INT SEE_QUIET_HIST_MULT = 126;
  ...
  TUNE_INT NMP_BASE_REDUCTION = 5156;
  TUNE_INT NMP_DEPTH_MULTIPLIER = 261;
  TUNE_INT NMP_REDUCTION_DEPTH_MULT = 17;
  TUNE_INT NMP_EVAL_MULT = 133;
  TUNE_INT NMP_FAILED_HIGH_HIST_BASE = 99;
  TUNE_INT NMP_FAILED_HIGH_HIST_MULT = 50;
  TUNE_INT NMP_EVAL_BETA_MARGIN = 70;
  TUNE_INT NMP_VERIFICATION_MARGIN = 34;
  TUNE_INT NMP_REDUCTION_DIVISOR = 16175;
  TUNE_INT NMP_EVAL_DIVISOR = 51152;
  ...
  TUNE_DOUBLE LMR_TABLE_BASE_NOISY = 0.359842442497604;
  TUNE_DOUBLE LMR_TABLE_NOISY_MULT = 126.47690817008205;
  TUNE_DOUBLE LMR_TABLE_BASE_QUIET = 0.9958132573488954;
  TUNE_DOUBLE LMR_TABLE_QUIET_MULT = 132.5549814838822;
  ...
  TUNE_INT QUIET_HISTORY_LMR_DIVISOR = 17199;
  TUNE_INT QUIET_HISTORY_LMR_MINIMUM_SCALAR = 3084;
  TUNE_INT QUIET_HISTORY_LMR_MAXIMUM_SCALAR = 3162;
  TUNE_INT PAWN_HISTORY_LMR_MULT = 3;
  TUNE_INT PAWN_HISTORY_LMR_DIVISOR = 16729;
  TUNE_INT PAWN_HISTORY_LMR_MINIMUM_SCALAR = 3048;
  TUNE_INT PAWN_HISTORY_LMR_MAXIMUM_SCALAR = 3039;
  TUNE_INT NOISY_HISTORY_LMR_MULT = 116;  
  TUNE_INT NOISY_HISTORY_LMR_DIVISOR = 1308885;
  TUNE_INT QUIET_NON_PV_LMR_SCALAR = 1000;
  TUNE_INT CUT_NODE_LMR_SCALAR = 1985;
  TUNE_INT TT_PV_LMR_SCALAR = 1028;
  TUNE_INT TT_PV_FAIL_LOW_LMR_SCALAR = 1047;
  TUNE_INT TT_CAPTURE_LMR_SCALAR = 1025;
  TUNE_INT GOOD_EVAL_LMR_SCALAR = 1030;
  TUNE_INT GOOD_EVAL_LMR_MARGIN = 344;
  TUNE_INT FUTILITY_LMR_BASE = 152;
  TUNE_INT FUTILITY_LMR_MULT = 87;
  TUNE_INT FUTILITY_LMR_SCALAR = 1005;
  TUNE_INT IMPROVING_LMR_SCALAR = 1007;
  TUNE_INT IMPROVING_FAIL_HIGH_MARGIN = 107;
  TUNE_INT GIVES_CHECK_LMR_SCALAR = 1040;
  TUNE_INT LMR_FUTILITY_OFFSET[] = {0, 164, 82, 41, 20, 10};
  TUNE_INT LMR_DEPTH_HIST_MULT = 2052;
  ...
  TUNE_INT LMP_HIST_MULT = 251;
  TUNE_INT LMP_HIST_DIVISOR = 15781;

/*╔═════════════╗
  ║   Probcut   ║
  ╚═════════════╝*/
  TUNE_INT PROBCUT_BETA_MARGIN = 156;
  TUNE_INT PROBCUT_DEPTH = 5;
  TUNE_INT PROBCUT_DEPTH_SUBTRACTOR = 4;
  TUNE_INT PROBCUT_IMPROVING_MARGIN = 30;
  TUNE_INT PROBCUT_SEE_NOISY_THRESHOLD = 98;
  TUNE_INT PROBCUT_NOISY_HIST_MULT = 119;
  TUNE_INT PROBCUT_FP_BASE = 163;
  TUNE_INT PROBCUT_FP_MULT = 99;


/*╔═══════════════════╗
  ║   Small Probcut   ║
  ╚═══════════════════╝*/
  TUNE_INT SPROBCUT_BETA_MARGIN = 356;
  ...
  /*╔════════════════════╗
    ║ Futility Pruning   ║
    ╚════════════════════╝*/
  TUNE_INT FUTILITY_PRUNING_OFFSET[] = {0, 87, 42, 20, 10, 5};
  TUNE_INT FP_DEPTH = 5;
  TUNE_INT FP_MARGIN = 80;
  TUNE_INT BNFP_MARGIN = 68;
  TUNE_INT QUIET_HISTORY_PRUNING_MARGIN = 2046;
  TUNE_INT FP_HIST_MULT = 490;
  TUNE_INT FP_HIST_DIVISOR = 16421;
  ...
  TUNE_INT RFP_IMPROVING_MARGIN = 44;
  TUNE_INT RFP_CORRPLEXITY_MULT = 19;
  ...
  TUNE_INT RAZORING_FULL_MARGIN = 204;    
  ...
  /*╔═════════════════════╗
    ...
    ╚═════════════════════╝*/
  TUNE_INT SE_DEPTH = 5;
  TUNE_INT LDSE_BASE_MARGIN = 26;
  TUNE_INT LDSE_CORRECTION_MULT = 764;
  TUNE_INT LDSE_CORRECTION_DIVISOR = 98345;
  ...
  /*╔══════════════════════════════╗
    ║      Aspiration Windows      ║
    ╚══════════════════════════════╝*/
  TUNE_INT ASP_WINDOW_BASE = 8;
  TUNE_INT ASP_WINDOW_MIN_DEPTH = 4;
  TUNE_DOUBLE ASP_WINDOW_MULTIPLIER = 1.8598793216924716;
...
/*╔═══════════════════════╗
  ...
  TUNE_INT QUIET_HIST_BONUS_DEPTH = 198;
  TUNE_INT QUIET_HIST_BONUS_MAX = 4065;
  TUNE_INT QUIET_HIST_MALUS_BASE = 10;
  TUNE_INT QUIET_HIST_MALUS_DEPTH = 197;
  TUNE_INT QUIET_HIST_FAILED_LOW_BONUS = 210;
  TUNE_INT QUIET_HIST_FAILED_LOW_MALUS = 206;
  TUNE_INT QUIET_HIST_MALUS_MAX = 4025;
  TUNE_INT HISTORY_RED_MULT = 1017;
  TUNE_INT HISTORY_RED_DIVISOR = 16709156;
  TUNE_INT CONTHIST_MULT = 1021;

  // Continuation History
  TUNE_INT CONTHIST_BONUS_BASE = 10;
  TUNE_INT CONTHIST_BONUS_DEPTH = 174;
  TUNE_INT CONTHIST_BONUS_MAX = 3975;
  TUNE_INT CONTHIST_MALUS_BASE = 11;
  TUNE_INT CONTHIST_MALUS_DEPTH = 208;
  TUNE_INT CONTHIST_FAILED_LOW_BONUS = 202;
  TUNE_INT CONTHIST_FAILED_LOW_MALUS = 181;
  TUNE_INT CONTHIST_MALUS_MAX = 4095;

  // Pawn History
  TUNE_INT PAWNHIST_BONUS_BASE = 10;
  TUNE_INT PAWNHIST_BONUS_DEPTH = 188;
  TUNE_INT PAWNHIST_BONUS_MAX = 4079;
  TUNE_INT PAWNHIST_MALUS_BASE = 10;
  TUNE_INT PAWNHIST_MALUS_DEPTH = 231;
  TUNE_INT PAWNHIST_FAILED_LOW_BONUS = 197;
  TUNE_INT PAWNHIST_FAILED_LOW_MALUS = 183;
  TUNE_INT PAWNHIST_MALUS_MAX = 4073;

  // Capture History
  TUNE_INT CAPTHIST_BONUS_BASE = 10;
  TUNE_INT CAPTHIST_BONUS_DEPTH = 205;
  TUNE_INT CAPTHIST_BONUS_MAX = 4117;
  TUNE_INT CAPTHIST_MALUS_BASE = 11;
  TUNE_INT CAPTHIST_MALUS_DEPTH = 203;
  TUNE_INT CAPTHIST_MALUS_MAX = 4060;  
