...
/*╔═══════════════════════════════╗
  ...
  TUNE_INT QS_SEE_THRESHOLD = 4;
  TUNE_INT SEE_MOVE_ORDERING_THRESHOLD = -60;
  TUNE_INT SEE_QUIET_THRESHOLD = -71;
  TUNE_INT SEE_NOISY_THRESHOLD = -40;
  TUNE_INT SEE_DEPTH = 10;
  TUNE_INT MOVE_ORDER_HIST_MULT = 350;
  TUNE_INT SEE_PRUNING_HIST_MULT = 558;
  TUNE_INT SEE_QUIET_HIST_MULT = 111;
  ...
  TUNE_INT NMP_BASE_REDUCTION = 5077;
  TUNE_INT NMP_DEPTH_MULTIPLIER = 245;
  TUNE_INT NMP_REDUCTION_DEPTH_MULT = 18;
  TUNE_INT NMP_EVAL_MULT = 95;
  TUNE_INT NMP_FAILED_HIGH_HIST_BASE = 110;
  TUNE_INT NMP_FAILED_HIGH_HIST_MULT = 60;
  TUNE_INT NMP_EVAL_BETA_MARGIN = 96;
  TUNE_INT NMP_VERIFICATION_MARGIN = 40;
  TUNE_INT NMP_REDUCTION_DIVISOR = 17119;
  TUNE_INT NMP_EVAL_DIVISOR = 42002;
  ...
  TUNE_DOUBLE LMR_TABLE_BASE_NOISY = 0.42707829406943654;
  TUNE_DOUBLE LMR_TABLE_NOISY_MULT = 131.61636345641526;
  TUNE_DOUBLE LMR_TABLE_BASE_QUIET = 0.968544856385441;
  TUNE_DOUBLE LMR_TABLE_QUIET_MULT = 144.99523678587622;
  ...
  TUNE_INT QUIET_HISTORY_LMR_DIVISOR = 18088;
  TUNE_INT QUIET_HISTORY_LMR_MINIMUM_SCALAR = 3335;
  TUNE_INT QUIET_HISTORY_LMR_MAXIMUM_SCALAR = 3151;
  TUNE_INT PAWN_HISTORY_LMR_MULT = 4;
  TUNE_INT PAWN_HISTORY_LMR_DIVISOR = 18305;
  TUNE_INT PAWN_HISTORY_LMR_MINIMUM_SCALAR = 2985;
  TUNE_INT PAWN_HISTORY_LMR_MAXIMUM_SCALAR = 3211;
  TUNE_INT NOISY_HISTORY_LMR_MULT = 103;  
  TUNE_INT NOISY_HISTORY_LMR_DIVISOR = 1314248;
  TUNE_INT QUIET_NON_PV_LMR_SCALAR = 907;
  TUNE_INT CUT_NODE_LMR_SCALAR = 2030;
  TUNE_INT TT_PV_LMR_SCALAR = 1021;
  TUNE_INT TT_PV_FAIL_LOW_LMR_SCALAR = 1077;
  TUNE_INT TT_CAPTURE_LMR_SCALAR = 897;
  TUNE_INT GOOD_EVAL_LMR_SCALAR = 835;
  TUNE_INT GOOD_EVAL_LMR_MARGIN = 229;
  TUNE_INT FUTILITY_LMR_BASE = 149;
  TUNE_INT FUTILITY_LMR_MULT = 87;
  TUNE_INT FUTILITY_LMR_SCALAR = 845;
  TUNE_INT IMPROVING_LMR_SCALAR = 1211;
  TUNE_INT IMPROVING_FAIL_HIGH_MARGIN = 108;
  TUNE_INT GIVES_CHECK_LMR_SCALAR = 1171;
  TUNE_INT LMR_FUTILITY_OFFSET[] = {0, 164, 82, 41, 20, 10};
  TUNE_INT LMR_DEPTH_HIST_MULT = 2032;
  ...
  TUNE_INT LMP_HIST_MULT = 236;
  TUNE_INT LMP_HIST_DIVISOR = 15547;

/*╔═════════════╗
  ║   Probcut   ║
  ╚═════════════╝*/
  TUNE_INT PROBCUT_BETA_MARGIN = 147;
  TUNE_INT PROBCUT_DEPTH = 5;
  TUNE_INT PROBCUT_DEPTH_SUBTRACTOR = 4;
  TUNE_INT PROBCUT_IMPROVING_MARGIN = 37;
  TUNE_INT PROBCUT_SEE_NOISY_THRESHOLD = 122;
  TUNE_INT PROBCUT_NOISY_HIST_MULT = 106;
  TUNE_INT PROBCUT_FP_BASE = 185;
  TUNE_INT PROBCUT_FP_MULT = 109;


/*╔═══════════════════╗
  ║   Small Probcut   ║
  ╚═══════════════════╝*/
  TUNE_INT SPROBCUT_BETA_MARGIN = 354;
  ...
  /*╔════════════════════╗
    ║ Futility Pruning   ║
    ╚════════════════════╝*/
  TUNE_INT FUTILITY_PRUNING_OFFSET[] = {0, 71, 41, 26, 11, 6};
  TUNE_INT FP_DEPTH = 5;
  TUNE_INT FP_MARGIN = 75;
  TUNE_INT BNFP_MARGIN = 72;
  TUNE_INT QUIET_HISTORY_PRUNING_MARGIN = 2078;
  TUNE_INT FP_HIST_MULT = 402;
  TUNE_INT FP_HIST_DIVISOR = 15440;
  ...
  TUNE_INT RFP_IMPROVING_MARGIN = 48;
  TUNE_INT RFP_CORRPLEXITY_MULT = 23;
  ...
  TUNE_INT RAZORING_FULL_MARGIN = 242;    
  TUNE_INT RAZORING_DEPTH_SCALE = 11;
  TUNE_INT RAZORING_VERIFY_MARGIN = 143;
  ...
  /*╔═════════════════════╗
    ...
    ╚═════════════════════╝*/
  TUNE_INT SE_DEPTH = 5;
  TUNE_INT LDSE_BASE_MARGIN = 19;
  TUNE_INT LDSE_CORRECTION_MULT = 787;
  TUNE_INT LDSE_CORRECTION_DIVISOR = 99350;
  ...
  /*╔══════════════════════════════╗
    ║      Aspiration Windows      ║
    ╚══════════════════════════════╝*/
  TUNE_INT ASP_WINDOW_BASE = 3;
  TUNE_INT ASP_WINDOW_MIN_DEPTH = 4;
  TUNE_DOUBLE ASP_WINDOW_MULTIPLIER = 2.2156573076828328;
...
/*╔═══════════════════════╗
  ...
  TUNE_INT QUIET_HIST_BONUS_DEPTH = 194;
  TUNE_INT QUIET_HIST_BONUS_MAX = 4297;
  TUNE_INT QUIET_HIST_MALUS_BASE = 11;
  TUNE_INT QUIET_HIST_MALUS_DEPTH = 141;
  TUNE_INT QUIET_HIST_FAILED_LOW_BONUS = 224;
  TUNE_INT QUIET_HIST_FAILED_LOW_MALUS = 229;
  TUNE_INT QUIET_HIST_MALUS_MAX = 3828;
  TUNE_INT HISTORY_RED_MULT = 1013;
  TUNE_INT HISTORY_RED_DIVISOR = 16886493;
  TUNE_INT CONTHIST_MULT = 1087;

  // Continuation History
  TUNE_INT CONTHIST_BONUS_BASE = 6;
  TUNE_INT CONTHIST_BONUS_DEPTH = 120;
  TUNE_INT CONTHIST_BONUS_MAX = 3505;
  TUNE_INT CONTHIST_MALUS_BASE = 11;
  TUNE_INT CONTHIST_MALUS_DEPTH = 208;
  TUNE_INT CONTHIST_FAILED_LOW_BONUS = 217;
  TUNE_INT CONTHIST_FAILED_LOW_MALUS = 204;
  TUNE_INT CONTHIST_MALUS_MAX = 4274;

  // Pawn History
  TUNE_INT PAWNHIST_BONUS_BASE = 11;
  TUNE_INT PAWNHIST_BONUS_DEPTH = 159;
  TUNE_INT PAWNHIST_BONUS_MAX = 3996;
  TUNE_INT PAWNHIST_MALUS_BASE = 7;
  TUNE_INT PAWNHIST_MALUS_DEPTH = 235;
  TUNE_INT PAWNHIST_FAILED_LOW_BONUS = 188;
  TUNE_INT PAWNHIST_FAILED_LOW_MALUS = 198;
  TUNE_INT PAWNHIST_MALUS_MAX = 4177;

  // Capture History
  TUNE_INT CAPTHIST_BONUS_BASE = 12;
  TUNE_INT CAPTHIST_BONUS_DEPTH = 224;
  TUNE_INT CAPTHIST_BONUS_MAX = 4101;
  TUNE_INT CAPTHIST_MALUS_BASE = 13;
  TUNE_INT CAPTHIST_MALUS_DEPTH = 297;
  TUNE_INT CAPTHIST_MALUS_MAX = 4351;  

  // Bad Quiet Index Scaling
  TUNE_INT BAD_QUIET_INDEX_SCALE = 19;
