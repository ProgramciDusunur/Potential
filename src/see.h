...
static inline U64 get_least_valuable_piece(U64 attadef, int side, int *targetPiece, const board* pos) {
    //pBitboard(attadef);
...
static inline int get_captured_piece(int move, const board* position) {
...
static inline int see(const board* pos, const int move) {
    int gain[32], d = 0;
