...
TUNE_INT PAWN_CORRHIST_WEIGHT_SCALE = 245;
TUNE_INT PAWN_CORRHIST_GRAIN = 268;
TUNE_INT MINOR_CORRHIST_WEIGHT_SCALE = 236;
TUNE_INT MINOR_CORRHIST_GRAIN = 295;
TUNE_INT MAJOR_CORRHIST_WEIGHT_SCALE = 279;
TUNE_INT MAJOR_CORRHIST_GRAIN = 261;
TUNE_INT NON_PAWN_CORRHIST_WEIGHT_SCALE = 256;
TUNE_INT NON_PAWN_CORRHIST_GRAIN = 313;
TUNE_INT KRP_CORRHIST_WEIGHT_SCALE = 240;
TUNE_INT KRP_CORRHIST_GRAIN = 349;
TUNE_INT CONT_CORRHIST_WEIGHT_SCALE = 251;
TUNE_INT CONT_CORRHIST_GRAIN = 263;
