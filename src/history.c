...
TUNE_INT PAWN_CORRHIST_WEIGHT_SCALE = 267;
TUNE_INT PAWN_CORRHIST_GRAIN = 263;
TUNE_INT MINOR_CORRHIST_WEIGHT_SCALE = 229;
TUNE_INT MINOR_CORRHIST_GRAIN = 263;
TUNE_INT MAJOR_CORRHIST_WEIGHT_SCALE = 276;
TUNE_INT MAJOR_CORRHIST_GRAIN = 277;
TUNE_INT NON_PAWN_CORRHIST_WEIGHT_SCALE = 257;
TUNE_INT NON_PAWN_CORRHIST_GRAIN = 317;
TUNE_INT KRP_CORRHIST_WEIGHT_SCALE = 250;
TUNE_INT KRP_CORRHIST_GRAIN = 328;
TUNE_INT CONT_CORRHIST_WEIGHT_SCALE = 255;
TUNE_INT CONT_CORRHIST_GRAIN = 251;
