...
TUNE_INT PAWN_CORRHIST_WEIGHT_SCALE = 239;
TUNE_INT PAWN_CORRHIST_GRAIN = 243;
TUNE_INT MINOR_CORRHIST_WEIGHT_SCALE = 275;
TUNE_INT MINOR_CORRHIST_GRAIN = 260;
TUNE_INT MAJOR_CORRHIST_WEIGHT_SCALE = 244;
TUNE_INT MAJOR_CORRHIST_GRAIN = 283;
TUNE_INT NON_PAWN_CORRHIST_WEIGHT_SCALE = 264;
TUNE_INT NON_PAWN_CORRHIST_GRAIN = 288;
TUNE_INT KRP_CORRHIST_WEIGHT_SCALE = 237;
TUNE_INT KRP_CORRHIST_GRAIN = 271;
