...
TUNE_INT PAWN_CORRHIST_WEIGHT_SCALE = 242;
TUNE_INT PAWN_CORRHIST_GRAIN = 216;
TUNE_INT MINOR_CORRHIST_WEIGHT_SCALE = 256;
TUNE_INT MINOR_CORRHIST_GRAIN = 251;
TUNE_INT MAJOR_CORRHIST_WEIGHT_SCALE = 259;
TUNE_INT MAJOR_CORRHIST_GRAIN = 275;
TUNE_INT NON_PAWN_CORRHIST_WEIGHT_SCALE = 263;
TUNE_INT NON_PAWN_CORRHIST_GRAIN = 304;
TUNE_INT KRP_CORRHIST_WEIGHT_SCALE = 261;
TUNE_INT KRP_CORRHIST_GRAIN = 283;
TUNE_INT CONT_CORRHIST_WEIGHT_SCALE = 257;
TUNE_INT CONT_CORRHIST_GRAIN = 228;
