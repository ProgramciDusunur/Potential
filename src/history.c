...
TUNE_INT PAWN_CORRHIST_WEIGHT_SCALE = 265;
TUNE_INT PAWN_CORRHIST_GRAIN = 237;
TUNE_INT PAWN_CORRHIST_MULT = 1044;
TUNE_INT MINOR_CORRHIST_WEIGHT_SCALE = 266;
TUNE_INT MINOR_CORRHIST_GRAIN = 235;
TUNE_INT MINOR_CORRHIST_MULT = 1054;
TUNE_INT MAJOR_CORRHIST_WEIGHT_SCALE = 243;
TUNE_INT MAJOR_CORRHIST_GRAIN = 294;
TUNE_INT MAJOR_CORRHIST_MULT = 981;
TUNE_INT NON_PAWN_CORRHIST_WEIGHT_SCALE = 243;
TUNE_INT NON_PAWN_CORRHIST_GRAIN = 295;
TUNE_INT NON_PAWN_CORRHIST_MULT = 1038;
TUNE_INT KRP_CORRHIST_WEIGHT_SCALE = 260;
TUNE_INT KRP_CORRHIST_GRAIN = 274;
TUNE_INT KRP_CORRHIST_MULT = 1017;
TUNE_INT CONT_CORRHIST_WEIGHT_SCALE = 264;
TUNE_INT CONT_CORRHIST_GRAIN = 209;
TUNE_INT CONT_CORRHIST_MULT = 975;
