...
TUNE_INT PAWN_CORRHIST_WEIGHT_SCALE = 269;
TUNE_INT PAWN_CORRHIST_GRAIN = 245;
TUNE_INT PAWN_CORRHIST_MULT = 978;
TUNE_INT MINOR_CORRHIST_WEIGHT_SCALE = 264;
TUNE_INT MINOR_CORRHIST_GRAIN = 265;
TUNE_INT MINOR_CORRHIST_MULT = 1056;
TUNE_INT MAJOR_CORRHIST_WEIGHT_SCALE = 247;
TUNE_INT MAJOR_CORRHIST_GRAIN = 295;
TUNE_INT MAJOR_CORRHIST_MULT = 1061;
TUNE_INT NON_PAWN_CORRHIST_WEIGHT_SCALE = 251;
TUNE_INT NON_PAWN_CORRHIST_GRAIN = 309;
TUNE_INT NON_PAWN_CORRHIST_MULT = 1071;
TUNE_INT KRP_CORRHIST_WEIGHT_SCALE = 266;
TUNE_INT KRP_CORRHIST_GRAIN = 291;
TUNE_INT KRP_CORRHIST_MULT = 1012;
TUNE_INT CONT_CORRHIST_WEIGHT_SCALE = 270;
TUNE_INT CONT_CORRHIST_GRAIN = 210;
TUNE_INT CONT_CORRHIST_MULT = 1023;
