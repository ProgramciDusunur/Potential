...
TUNE_INT PAWN_CORRHIST_WEIGHT_SCALE = 258;
TUNE_INT PAWN_CORRHIST_GRAIN = 223;
TUNE_INT PAWN_CORRHIST_MULT = 1077;
TUNE_INT MINOR_CORRHIST_WEIGHT_SCALE = 290;
TUNE_INT MINOR_CORRHIST_GRAIN = 241;
TUNE_INT MINOR_CORRHIST_MULT = 921;
TUNE_INT MAJOR_CORRHIST_WEIGHT_SCALE = 264;
TUNE_INT MAJOR_CORRHIST_GRAIN = 262;
TUNE_INT MAJOR_CORRHIST_MULT = 897;
TUNE_INT NON_PAWN_CORRHIST_WEIGHT_SCALE = 233;
TUNE_INT NON_PAWN_CORRHIST_GRAIN = 268;
TUNE_INT NON_PAWN_CORRHIST_MULT = 1013;
TUNE_INT KRP_CORRHIST_WEIGHT_SCALE = 249;
TUNE_INT KRP_CORRHIST_GRAIN = 292;
TUNE_INT KRP_CORRHIST_MULT = 921;
TUNE_INT CONT_CORRHIST_WEIGHT_SCALE = 284;
TUNE_INT CONT_CORRHIST_GRAIN = 241;
TUNE_INT CONT_CORRHIST_MULT = 1101;
