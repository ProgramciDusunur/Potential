...
TUNE_INT PAWN_CORRHIST_WEIGHT_SCALE = 255;
TUNE_INT PAWN_CORRHIST_GRAIN = 222;
TUNE_INT MINOR_CORRHIST_WEIGHT_SCALE = 260;
TUNE_INT MINOR_CORRHIST_GRAIN = 257;
TUNE_INT MAJOR_CORRHIST_WEIGHT_SCALE = 252;
TUNE_INT MAJOR_CORRHIST_GRAIN = 279;
TUNE_INT NON_PAWN_CORRHIST_WEIGHT_SCALE = 262;
TUNE_INT NON_PAWN_CORRHIST_GRAIN = 305;
TUNE_INT KRP_CORRHIST_WEIGHT_SCALE = 265;
TUNE_INT KRP_CORRHIST_GRAIN = 283;
TUNE_INT CONT_CORRHIST_WEIGHT_SCALE = 269;
TUNE_INT CONT_CORRHIST_GRAIN = 220;
