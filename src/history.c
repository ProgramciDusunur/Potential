...
TUNE_INT PAWN_CORRHIST_WEIGHT_SCALE = 256;
TUNE_INT PAWN_CORRHIST_GRAIN = 256;
TUNE_INT MINOR_CORRHIST_WEIGHT_SCALE = 256;
TUNE_INT MINOR_CORRHIST_GRAIN = 256;
TUNE_INT MAJOR_CORRHIST_WEIGHT_SCALE = 256;
TUNE_INT MAJOR_CORRHIST_GRAIN = 256;
TUNE_INT NON_PAWN_CORRHIST_WEIGHT_SCALE = 256;
TUNE_INT NON_PAWN_CORRHIST_GRAIN = 256;
TUNE_INT KRP_CORRHIST_WEIGHT_SCALE = 256;
TUNE_INT KRP_CORRHIST_GRAIN = 256;
TUNE_INT CONT_CORRHIST_WEIGHT_SCALE = 256;
TUNE_INT CONT_CORRHIST_GRAIN = 256;
