...
TUNE_INT PAWN_CORRHIST_WEIGHT_SCALE = 215;
TUNE_INT PAWN_CORRHIST_GRAIN = 303;
TUNE_INT MINOR_CORRHIST_WEIGHT_SCALE = 302;
TUNE_INT MINOR_CORRHIST_GRAIN = 267;
TUNE_INT MAJOR_CORRHIST_WEIGHT_SCALE = 279;
TUNE_INT MAJOR_CORRHIST_GRAIN = 267;
TUNE_INT NON_PAWN_CORRHIST_WEIGHT_SCALE = 267;
TUNE_INT NON_PAWN_CORRHIST_GRAIN = 333;
TUNE_INT KRP_CORRHIST_WEIGHT_SCALE = 237;
TUNE_INT KRP_CORRHIST_GRAIN = 269;
