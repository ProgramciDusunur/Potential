...
TUNE_INT PAWN_CORRHIST_GRAIN = 257;
TUNE_INT MINOR_CORRHIST_WEIGHT_SCALE = 264;
TUNE_INT MINOR_CORRHIST_GRAIN = 247;
TUNE_INT MAJOR_CORRHIST_WEIGHT_SCALE = 264;
TUNE_INT MAJOR_CORRHIST_GRAIN = 267;
TUNE_INT NON_PAWN_CORRHIST_WEIGHT_SCALE = 249;
TUNE_INT NON_PAWN_CORRHIST_GRAIN = 273;
TUNE_INT KRP_CORRHIST_WEIGHT_SCALE = 254;
TUNE_INT KRP_CORRHIST_GRAIN = 249;
TUNE_INT CONT_CORRHIST_WEIGHT_SCALE = 275;
TUNE_INT CONT_CORRHIST_GRAIN = 234;
