...
int PAWN_CORRHIST_WEIGHT_SCALE = 256;
int PAWN_CORRHIST_GRAIN = 256;
int MINOR_CORRHIST_WEIGHT_SCALE = 256;
int MINOR_CORRHIST_GRAIN = 256;
int MAJOR_CORRHIST_WEIGHT_SCALE = 256;
int MAJOR_CORRHIST_GRAIN = 256;
int NON_PAWN_CORRHIST_WEIGHT_SCALE = 256;
int NON_PAWN_CORRHIST_GRAIN = 256;
int KRP_CORRHIST_WEIGHT_SCALE = 256;
int KRP_CORRHIST_GRAIN = 256;
int CONT_CORRHIST_WEIGHT_SCALE = 256;
int CONT_CORRHIST_GRAIN = 256;
