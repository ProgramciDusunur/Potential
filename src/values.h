...
enum {
   STAGE_QS_EVASIONS_TT,
   STAGE_QS_EVASIONS_GEN_NOISY,
   STAGE_QS_EVASIONS_GOOD_NOISY,
   STAGE_QS_EVASIONS_GEN_QUIET,
   STAGE_QS_EVASIONS_QUIET,
   STAGE_QS_EVASIONS_BAD_NOISY,
   CURRENT_QS_STAGE
};
