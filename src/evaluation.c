...
// Game Phase Scores
TUNE_INT opening_phase_score = 7756;
TUNE_INT endgame_phase_score = 533;

TUNE_INT MG_PAWN_MAT = 52;
TUNE_INT MG_KNIGHT_MAT = 357;
TUNE_INT MG_BISHOP_MAT = 398;
TUNE_INT MG_ROOK_MAT = 482;
TUNE_INT MG_QUEEN_MAT = 1081;

TUNE_INT EG_PAWN_MAT = 109;
TUNE_INT EG_KNIGHT_MAT = 373;
TUNE_INT EG_BISHOP_MAT = 404;
TUNE_INT EG_ROOK_MAT = 725;
TUNE_INT EG_QUEEN_MAT = 1274;
