...
// SEE Material Array
const int seeMaterial[12] = {90, 263, 304, 508, 1251, 12000, -90, -263, -304, -508, -1251, -12000};

// Tuned Material scores  paste into evaluation.c
const int material_score[2][12] = {
    { 70, 339, 401, 521, 1135, 0, -70, -339, -401, -521, -1135, 0 },
    { 105, 356, 398, 678, 1292, 0, -105, -356, -398, -678, -1292, 0 }
};
