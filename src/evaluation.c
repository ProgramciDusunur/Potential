...
TUNE_INT MG_BISHOP_MAT = 409;
TUNE_INT MG_ROOK_MAT = 524;
TUNE_INT MG_QUEEN_MAT = 1100;

TUNE_INT EG_PAWN_MAT = 105;
TUNE_INT EG_KNIGHT_MAT = 362;
TUNE_INT EG_BISHOP_MAT = 404;
TUNE_INT EG_ROOK_MAT = 710;
TUNE_INT EG_QUEEN_MAT = 1279;
