...
// SEE Material Array
const int seeMaterial[12] = {82, 253, 300, 500, 1241, 12000, -82, -253, -300, -500, -1241, -12000};

TUNE_INT MG_PAWN_MAT = 60;
TUNE_INT MG_KNIGHT_MAT = 353;
TUNE_INT MG_BISHOP_MAT = 411;
TUNE_INT MG_ROOK_MAT = 538;
TUNE_INT MG_QUEEN_MAT = 1099;

TUNE_INT EG_PAWN_MAT = 116;
TUNE_INT EG_KNIGHT_MAT = 350;
TUNE_INT EG_BISHOP_MAT = 393;
TUNE_INT EG_ROOK_MAT = 701;
TUNE_INT EG_QUEEN_MAT = 1356;
