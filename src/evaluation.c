...
// SEE Material Array
const int seeMaterial[12] = {94, 258, 306, 500, 1301, 12000, -94, -258, -306, -500, -1301, -12000};

TUNE_INT MG_PAWN_MAT = 62;
TUNE_INT MG_KNIGHT_MAT = 347;
TUNE_INT MG_BISHOP_MAT = 394;
TUNE_INT MG_ROOK_MAT = 539;
TUNE_INT MG_QUEEN_MAT = 1137;

TUNE_INT EG_PAWN_MAT = 109;
TUNE_INT EG_KNIGHT_MAT = 363;
TUNE_INT EG_BISHOP_MAT = 403;
TUNE_INT EG_ROOK_MAT = 668;
TUNE_INT EG_QUEEN_MAT = 1307;
