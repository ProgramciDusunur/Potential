...
// SEE Material Array
const int seeMaterial[12] = {85, 327, 299, 505, 1255, 12000, -85, -327, -299, -505, -1255, -12000};

TUNE_INT MG_PAWN_MAT = 62;
TUNE_INT MG_KNIGHT_MAT = 362;
TUNE_INT MG_BISHOP_MAT = 398;
TUNE_INT MG_ROOK_MAT = 523;
TUNE_INT MG_QUEEN_MAT = 1082;

TUNE_INT EG_PAWN_MAT = 104;
TUNE_INT EG_KNIGHT_MAT = 367;
TUNE_INT EG_BISHOP_MAT = 402;
TUNE_INT EG_ROOK_MAT = 686;
TUNE_INT EG_QUEEN_MAT = 1273;
