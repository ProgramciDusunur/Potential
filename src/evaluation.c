...
// SEE Material Array
const int seeMaterial[12] = {82, 328, 310, 500, 1277, 12000, -82, -328, -310, -500, -1277, -12000};

TUNE_INT MG_PAWN_MAT = 61;
TUNE_INT MG_KNIGHT_MAT = 355;
TUNE_INT MG_BISHOP_MAT = 395;
TUNE_INT MG_ROOK_MAT = 512;
TUNE_INT MG_QUEEN_MAT = 1093;

TUNE_INT EG_PAWN_MAT = 102;
TUNE_INT EG_KNIGHT_MAT = 367;
TUNE_INT EG_BISHOP_MAT = 403;
TUNE_INT EG_ROOK_MAT = 698;
TUNE_INT EG_QUEEN_MAT = 1270;
