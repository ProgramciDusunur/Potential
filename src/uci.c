...
TUNE_DOUBLE DEF_TIME_MULTIPLIER = 0.0540;
TUNE_DOUBLE DEF_INC_MULTIPLIER = 0.8500;
TUNE_DOUBLE MAX_TIME_MULTIPLIER = 0.7600;
TUNE_DOUBLE HARD_LIMIT_MULTIPLIER = 3.0400;
TUNE_DOUBLE SOFT_LIMIT_MULTIPLIER = 0.7600;

TUNE_DOUBLE TM_BEST_MOVE_SCALE_0 = 2.4300;
TUNE_DOUBLE TM_BEST_MOVE_SCALE_1 = 1.3500;
TUNE_DOUBLE TM_BEST_MOVE_SCALE_2 = 1.0900;
TUNE_DOUBLE TM_BEST_MOVE_SCALE_3 = 0.8800;
TUNE_DOUBLE TM_BEST_MOVE_SCALE_4 = 0.6800;

TUNE_DOUBLE TM_EVAL_SCALE_0 = 1.2500;
TUNE_DOUBLE TM_EVAL_SCALE_1 = 1.1500;
TUNE_DOUBLE TM_EVAL_SCALE_2 = 1.0000;
TUNE_DOUBLE TM_EVAL_SCALE_3 = 0.9400;
TUNE_DOUBLE TM_EVAL_SCALE_4 = 0.8800;

TUNE_DOUBLE TM_COMPLEXITY_BASE = 0.7700;
TUNE_DOUBLE TM_COMPLEXITY_DIVISOR = 400.0000;
TUNE_DOUBLE TM_COMPLEXITY_MULT = 0.6000;
TUNE_DOUBLE TM_NODE_FRACTION_BASE = 1.5000;
TUNE_DOUBLE TM_NODE_MULTIPLIER = 1.3500;
